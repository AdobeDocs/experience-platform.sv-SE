...
En fullständig guide till [!UICONTROL Profiles] användargränssnittet finns i användarhandboken för [profiler](user-guide.md).
...
Det valda kortet justeras till önskad storlek och omgivande kort flyttas dynamiskt. Detta kan medföra att vissa kort flyttas till ytterligare rader, vilket kräver att du rullar nedåt för att se alla kort. När [!UICONTROL Basic attributes] kortets storlek t.ex. ändras är [!UICONTROL Linked identities] kortet inte längre synligt på den översta raden och visas nu på en ny andra rad i profilen (visas inte). Om du vill flytta tillbaka [!UICONTROL Linked identities] kortet till den översta raden kan du dra och släppa det i [!UICONTROL Channel preferences] kortets nuvarande position.
...
Om du någon gång bestämmer dig för att du vill ta bort redigeringarna och återgå till standardvyn kan du snabbt och enkelt återställa alla standardkort och -attribut. Om du vill göra det väljer du **[UICONTROL Ändra kontrollpanel]** och väljer sedan **[UICONTROL Återställ standardkort]**. Då tas alla anpassningar bort (inklusive storleksändring) som du har gjort bort. Om du vill fortsätta väljer du **[Spara]** med UICONTROL för att spara ändringarna. Om du väljer att återställa av misstag väljer du **[UICONTROL Avbryt]** för att undvika att spara ändringarna och behålla ändringarna du gjort.
