...
Om du vill veta mer om kopplingsprofiler och vilken roll de spelar i Experience Platform börjar du med att läsa översikten [för kopplingsprofiler](overview.md).
...
Arbetsflödet **[!UICONTROL New merge policy]** kräver att du anger viktig information för den nya sammanfogningsprincipen genom en serie guidade steg. De här stegen beskrivs i de efterföljande avsnitten.
...
Detaljerad information om unionsscheman, inklusive hur du interagerar med dem på fliken [!UICONTROL Union Schema] eller i dialogrutan [!UICONTROL View Union Schema] som visas i arbetsflödet för sammanslagningsprinciper finns i användargränssnittsguiden för [unionsschemat](../ui/union-schema.md).
...
>[!NOTE]
>
>Antalet hakparenteser bredvid **[!UICONTROL ExperienceEvent datasets]** (till exempel `(20)` i bilden som visas) visar det totala antalet ExperienceEvent-datamängder som skapats av din organisation och som relaterar till den schemaklass som du valde på konfigurationsskärmen för sammanfogningsprincipen.
...
När du väljer datauppsättningar visas de i [!UICONTROL Select datasets]-avsnittet.
...
Den **[!UICONTROL Preview data]**-tabell som visar exempelprofilposter med hjälp av din sammanfogningsprincip finns också på granskningsskärmen. På så sätt kan du förhandsgranska hur en kundprofil ser ut innan du sparar sammanfogningspolicyn.
...
När skärmen **[!UICONTROL Edit merge policy]** visas kan du ändra namnet och metoden [!UICONTROL ID stitching] samt ändra om den här principen är organisationens standardprincip för sammanslagning eller inte.
...
Nu när ni har skapat och konfigurerat sammanfogningsprinciper för er organisation kan ni använda dem för att justera visningen av kundprofiler inom Platform och för att skapa målgruppssegment utifrån era profildata. Mer information om hur du skapar och arbetar med segment med hjälp av användargränssnittet och API:erna i [!DNL Experience Platform] finns i [segmenteringsöversikten](../../segmentation/home.md).
