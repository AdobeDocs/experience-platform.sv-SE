...
Mer information om alternativen för tilläggskonfigurationen finns på [Adobe Target v2-tilläggssidan](../../../tags/extensions/web/target-v2/overview.md) i taggdokumentationen.
