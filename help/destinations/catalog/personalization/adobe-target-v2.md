...
# [!DNL Adobe Target] v2-tillägg {#adobe-target-v2-extension}
...
[!DNL Adobe Target] v2 är ett personaliseringstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
Så här installerar du tillägget [!DNL Adobe Target] v2:
