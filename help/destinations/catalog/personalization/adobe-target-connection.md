...
Tabellen nedan visar de användningsfall som stöds för Adobe Target-destinationen, baserat på din implementeringstyp, med eller utan Web SDK och med eller utan [kantsegmentering](/help/segmentation/home.md#edge) aktiverat.
...
När du konfigurerar Adobe Target-anslutningen till [använd ett datastream](#parameters) måste du ha [Adobe Experience Platform Data Collection](/help/collection/home.md) implementerat.

Om du konfigurerar Adobe Target-anslutningen utan att använda en datastream behöver du inte implementera Web SDK.

>[!IMPORTANT]
>
>Innan du skapar en [!DNL Adobe Target]-anslutning bör du läsa guiden om hur du [konfigurerar anpassningsmål för samma sida och nästa sida &#x200B;](../../ui/activate-edge-personalization-destinations.md). Den här guiden tar dig igenom de nödvändiga konfigurationsstegen för användning av samma sida och nästa sida för personalisering, i flera Experience Platform-komponenter. För att uppnå anpassningsexempel på samma sida och nästa sida måste du använda ett datastream när du konfigurerar Adobe Target-anslutningen.
...
* **Datastream**: Detta avgör i vilket datamängdsdatastam som målgrupperna ska inkluderas. I den nedrullningsbara menyn visas endast datastreams som har tjänsterna Target och Adobe Experience Platform aktiverade. Mer information om hur du konfigurerar ett datastream för Adobe Experience Platform och Adobe Target finns i [konfigurera ett datastream](../../../datastreams/configure.md#aep).

  >[!IMPORTANT]
  >
  >**Datastream-unika i hela organisationen**: Kombinationen av datastream-ID och sandlådenamn måste vara unik för Adobe Target-målanslutningar i en IMS-organisation. Detta innebär:
  >
  >* Samma kombination av dataStream ID + sandlådenamn kan inte användas för flera Adobe Target-målanslutningar i hela organisationen
