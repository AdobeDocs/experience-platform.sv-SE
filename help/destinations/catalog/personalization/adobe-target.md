...
Mer information om alternativen för tilläggskonfigurationen finns på sidan [Adobe Target-tillägg](../../../tags/extensions/web/target/overview.md) i dokumentationen för Experience [!DNL Launch].
