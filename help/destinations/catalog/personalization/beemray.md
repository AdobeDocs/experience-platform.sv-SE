...
[!DNL Beemray] hjälper dig att snabba upp din produkt med situationssammanhang. Gör det möjligt för er att få insikter, skapa nya upplevelser, skapa interaktioner och engagera i ögonblick som verkligen betyder något. Beemray automatiserar kontextuell intelligens med maskininlärning. Beemray ansluter till [!DNL Adobe Experience Cloud] och resten av dina tekniska partner. Allt äger rum i realtid. Det här tillägget installerar [!DNL Beemray] SDK på din webbplats.

Beemray är ett personaliseringstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html).
