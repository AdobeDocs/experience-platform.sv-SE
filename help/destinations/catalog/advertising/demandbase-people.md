...
Marknadsförarna kan använda Adobe [!DNL Real-Time CDP] för att skapa en personlista över förstahandskontakter och aktivera den i Demandbase för optimerat och orkestrerat engagemang på dess DSP (DSP) och andra kanaler som LinkedIn.
...
* **Målgruppsnamn**: Om en målgrupp med samma namn aktiverades tidigare i Demandbase kan du inte aktivera den igen via ett annat dataflöde till Demandbase-målet.
