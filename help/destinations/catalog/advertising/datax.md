...
>[!IMPORTANT]
>
>Den här målanslutnings- och dokumentationssidan skapas och underhålls av [!DNL Verizon Media/Yahoo]-teamet hos [!DNL DataX]. Om du har frågor eller uppdateringsfrågor kontaktar du dem direkt på [dataoperations@yahooinc.com](mailto:dataoperations@yahooinc.com)
...
![Yahoo DataX-målkort i Experience Platform UI](/help/destinations/assets/catalog/advertising/yahoo-datax/catalog.png)
