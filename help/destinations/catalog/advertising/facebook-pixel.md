...
# [!DNL Facebook Pixel]-tillägg {#facebook-pixel-extension}
...
[!DNL Facebook Pixel] är ett annonstillägg i Adobe Experience Platform. Mer information om tilläggsfunktioner finns på webbplatsen [Facebook Pixel](https://developers.facebook.com/docs/facebook-pixel/).
