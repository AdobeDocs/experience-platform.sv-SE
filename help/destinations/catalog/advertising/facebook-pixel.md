---
keywords: facebook pixeltillägg;facebook pixeltillägg;facebook pixelmål;facebook pixel
title: Facebook Pixel-tillägg
description: Tillägget Facebook Pixel är ett reklammål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
The [!DNL Facebook Pixel] är ett analysverktyg som gör att ni kan mäta hur effektiv er annonsering är genom att förstå vilka åtgärder användarna vidtar på er webbplats.

[!DNL Facebook Pixel] är ett reklamtillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns i [Facebook Pixel webbplats](https://developers.facebook.com/docs/facebook-pixel/).
...
![Facebook Pixel-tillägg](../../assets/catalog/advertising/facebook-pixel/catalog.png)
...
Så här installerar du [!DNL Facebook Pixel] tillägg:
