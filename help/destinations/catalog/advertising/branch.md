...
title: Förgreningstillägg
description: Branch-tillägget är ett reklammål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
# [!DNL Branch]-tillägg {#branch-extension}
...
Grenen är ett annonstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på sidan [features](https://branch.io/features/) på webbplatsen Branch.
