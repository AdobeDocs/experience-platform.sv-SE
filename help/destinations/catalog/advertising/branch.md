...
Filialen är ett reklamtillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns i [features page](https://branch.io/features/) på filialens webbplats.
...
Så här installerar du [!DNL Branch] tillägg:
