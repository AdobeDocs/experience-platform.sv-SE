...
Installera [!DNL LinkedIn Insight Tag] för att använda funktioner för konverteringsspårning, återmarknadsföring och demografi på webbplatser.

[!DNL LinkedIn Insight Tag] är ett reklamtillägg i Adobe Experience Platform. Mer information om tilläggsfunktioner finns i [linkedIn Insight-tagg](https://business.linkedin.com/marketing-solutions/insight-tag).
...
Så här installerar du [!DNL LinkedIn Insight Tag] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [linkedIn Insight-tagg](https://business.linkedin.com/marketing-solutions/insight-tag).
