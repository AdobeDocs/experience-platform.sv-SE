...
description: Tillägget Flashtalk OneTag är ett annonsmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
# [!DNL Flashtalking OneTag]-tillägg {#flashtalking-extension}

## Översikt {#overview}

Med taggtillägget [!DNL Flashtalking OneTag] är det enkelt att attribuera webbplatsåtgärder för visning, video och mobilannonsaktivitet. Distribuera [!DNL Flashtalking OneTag] till dina webbegenskaper med taggar.

[!DNL Flashtalking OneTag] är ett annonstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![Tillägget Flashtalk](../../assets/catalog/advertising/flashtalking/catalog.png)
...
Så här installerar du tillägget [!DNL Flashtalking OneTag]:
...
Information om alternativ för tilläggskonfiguration och installationsstöd finns på [sidan Flashtalk OneTag på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
