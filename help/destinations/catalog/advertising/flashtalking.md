...
The [!DNL Flashtalking OneTag] taggtillägg gör det enkelt att attribuera webbplatsåtgärder för visning, video och mobilannonsering. Distribuera [!DNL Flashtalking OneTag] till dina webbegenskaper med hjälp av taggar.
...
![Flashtalk-tillägg](../../assets/catalog/advertising/flashtalking/catalog.png)
...
Så här installerar du [!DNL Flashtalking OneTag] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [Flashtalk OneTag page on Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
