...
Den här anslutningen ersätter den [gamla Adobe Advertising Cloud DSP-anslutningen](adobe-advertising-cloud-dsp-connection-legacy.md), som bara stöder hash-kodade e-postadresser.
...
>additional-url="https://experienceleague.adobe.com/sv/docs/experience-platform/destinations/catalog/advertising/adobe-advertising-dsp-connection#preconfigured-mappings" text="Läs mer om förkonfigurerade mappningar"
