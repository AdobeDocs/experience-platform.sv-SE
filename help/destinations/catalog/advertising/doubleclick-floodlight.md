...
description: DoubleClick Floodlight-tillägget (Beta) är ett annonsmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
[!DNL DoubleClick Floodlight] (Beta) är ett annonstillägg i Adobe Experience Platform. Mer information om tilläggsfunktioner finns i [!DNL Google] supportdokumentation för [DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en).
