...
Läs in Google `gtag.js` på din webbplats för att skicka händelsedata till [!DNL Google Analytics], Google Ads och [!DNL Google Marketing Platform]. Det här tillägget lägger bara till gtag-koden på din plats. Du måste använda andra Google-tillägg för att lägga till händelser och åtgärder som ska använda gtag.

Google Gtag är ett annonstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html).
