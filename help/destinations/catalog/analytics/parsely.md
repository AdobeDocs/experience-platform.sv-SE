...
description: Tillägget Parse.ly Analytics är ett analysmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
[!DNL Parse.ly Analytics] hjälper fler än 2 500 företag att använda data för att förstå sin onlinepublik. Det här tillägget installerar ett JavaScript-fragment som spårar hur besökare interagerar med innehåll på webbplatsen.
...
![Analysera.ly Analytics-tillägg](../../assets/catalog/analytics/parsely/catalog.png)
...
Så här installerar du tillägget [!DNL Parse.ly]:
