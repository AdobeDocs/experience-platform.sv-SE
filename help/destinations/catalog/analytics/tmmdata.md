...
description: TMMData-tillägget är ett analysmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
[!DNL TMMData's] Foundation-plattformen för Adobe Marketing Cloud ger marknadsföringsteamen de verktyg de behöver för att få tillgång till och blanda alla viktiga datakällor - inklusive interna/externa och online-/offlinedata - för säker, omfattande flerkanalsanalys, med automatiserad kampanjkonfiguration och direktimport till Adobe och andra analys- och BI-verktyg.

[!DNL TMMData] är ett analystillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
...
![TMMData-tillägg](../../assets/catalog/analytics/tmmdata/catalog.png)
...
Så här installerar du tillägget [!DNL TMMData]:
...
Information om alternativ för tilläggskonfiguration och installationsstöd finns på [TMMData-sidan på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
