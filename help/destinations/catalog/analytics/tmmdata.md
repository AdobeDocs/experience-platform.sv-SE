...
[!DNL TMMData's] Foundation platform for Adobe Marketing Cloud ger marknadsföringsteamen de verktyg de behöver för att få tillgång till och kombinera alla viktiga datakällor - inklusive interna/externa och online-/offlinedata - för säker, omfattande flerkanalsanalys, med automatiserad kampanjkonfiguration och direktimport till Adobe och andra analys- och BI-verktyg.
...
Så här installerar du [!DNL TMMData] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [TMMData-sida på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html).
