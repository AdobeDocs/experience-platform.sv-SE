...
The [!DNL Clicktale] Med taggtillägg kan du distribuera kod och mappa dataelement med [!DNL Clicktale's] Visual Editor.
...
Så här installerar du [!DNL Clicktale] tillägg:
...
Mer information om alternativen för tilläggskonfigurationen finns i [Klickbar tilläggssida](https://exchange.adobe.com/experiencecloud.details.100082.html) på Adobe Exchange.
