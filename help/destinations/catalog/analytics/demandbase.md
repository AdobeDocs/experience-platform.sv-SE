...
Hämta [!DNL Demandbase] B2B-kontoinsikter direkt in i Adobe Analytics där ni kan segmentera trafik och beteende efter bransch, intäkt och målkonton. Denna kontobaserade vy ger unika insikter om engagemang, konvertering och källan för era mest värdefulla besökare.
...
Så här installerar du [!DNL Demandbase] tillägg:
...
Mer information om alternativen för tilläggskonfigurationen finns i [Tilläggssida för Demandbase](https://exchange.adobe.com/experiencecloud.details.101605.html) på Adobe Exchange.
