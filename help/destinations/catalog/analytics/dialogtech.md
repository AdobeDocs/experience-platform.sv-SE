...
[!DNL DialogTech] är ett analystillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns i [Dialogtech website](https://www.dialogtech.com/).
...
Så här installerar du [!DNL DialogTech] tillägg:
