...
[!DNL SessionCam] är ett analystillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
...
Mer information om alternativ för tilläggskonfiguration och installationsstöd finns på sidan [SessionCam på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
