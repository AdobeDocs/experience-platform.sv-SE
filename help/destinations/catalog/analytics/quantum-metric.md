...
description: Quantum Metric-tillägget är ett analysmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
Taggtillägget [!DNL Quantum Metric] underlättar kodlös distribution av datainsamlingsfunktioner i [!DNL Quantum Metric's]. Det här tillägget ger dessutom möjlighet att samla in dataelement som innehåller användbar information från API:t [!DNL Quantum Metric].

[!DNL Quantum Metric] är ett analystillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
Så här installerar du tillägget [!DNL Quantum Metric]:
...
Information om alternativ för tilläggskonfiguration och installationsstöd finns på sidan [Quantum Metric i Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
