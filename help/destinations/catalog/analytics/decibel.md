...
Snabb och smidig driftsättning [!DNL Decibel] på dina webbegenskaper. Ytterligare avancerade konfigurationer kan också distribueras med regler med hjälp av åtgärder som är tillgängliga via tillägget.
...
Så här installerar du [!DNL Decibel] tillägg:
...
Mer information om alternativen för tilläggskonfigurationen finns i [Decibel extension page](https://exchange.adobe.com/experiencecloud.details.100913.html) på Adobe Exchange.
