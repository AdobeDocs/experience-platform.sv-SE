...
description: Tillägget Nielsen IMA Handler är ett analysmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
[!DNL Nielsen IMA Handler] är ett analystillägg i [!DNL Adobe Experience Platform].
