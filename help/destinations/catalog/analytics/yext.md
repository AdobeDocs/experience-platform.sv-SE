...
The [!DNL Yext Conversion Tracking] Med Extension kan du mäta konverteringar som kan tillskrivas din användning av Yext-produkter.
...
Så här installerar du [!DNL Yext Conversion Tracking] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [Sidan för spårning av konvertering på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
