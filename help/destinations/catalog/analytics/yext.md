...
[!DNL Yext Conversion Tracking] är ett analystillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
![Anknyt till konverteringsspårning](../../assets/catalog/analytics/yext/catalog.png)
...
Mer information om alternativen för tilläggskonfiguration och installationsstöd finns på [Textkonverteringsspårning på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
