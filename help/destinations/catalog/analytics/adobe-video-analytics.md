...
Mer information om alternativen för tilläggskonfigurationen finns i [Adobe Media Analytics for Audio and Video extension page](../../../tags/extensions/web/media-analytics/overview.md) i [!DNL Experience Launch]-dokumentationen.
