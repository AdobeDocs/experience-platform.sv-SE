...
Mer information om alternativen för tilläggskonfigurationen finns på sidan [Adobe Media Analytics for Audio and Video extension](../../../tags/extensions/web/media-analytics/overview.md) i taggdokumentationen.
