...
Mer information om alternativen för tilläggskonfigurationen finns i [Adobe Media Analytics for Audio and Video extension page](../../../tags/extensions/client/media-analytics/overview.md) i taggdokumentationen.
