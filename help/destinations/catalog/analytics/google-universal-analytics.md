...
# [!DNL Google Universal Analytics]-tillägg {#google-universal-analytics-extension}

## Översikt {#overview}

Med [!DNL Google Universal Analytics] kan du mäta avkastningen på annonseringen samt spåra Flash, video och sociala nätverksplatser och program.

[!DNL Google Universal Analytics] är ett analystillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html).
...
Mer information om alternativen för tilläggskonfigurationen finns på [tilläggssidan för Google Universal Analytics](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html) på Adobe Exchange.
