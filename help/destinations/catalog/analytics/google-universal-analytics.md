...
Så här installerar du [!DNL Google Universal Analytics] tillägg:
...
Mer information om alternativen för tilläggskonfigurationen finns i [Google Universal Analytics-tilläggssida](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html) på Adobe Exchange.
