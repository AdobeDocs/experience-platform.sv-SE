...
description: Marketo Engage är den enda heltäckande CXM-lösningen (Customer Experience Management) för marknadsföring, reklam, analys och handel. Använd det för att automatisera och hantera aktiviteter från CRM-lead-hantering och kundengagemang till kontobaserad marknadsföring och intäktsattribuering.
...
[!DNL Marketo Engage] är den enda heltäckande CXM-lösningen (Customer Experience Management) för marknadsföring, reklam, analys och handel. Använd det för att automatisera och hantera aktiviteter från CRM-lead-hantering och kundengagemang till kontobaserad marknadsföring och intäktsattribuering.
...
* **[!UICONTROL Partition]**: *Partitionsval är bara tillgängligt när du väljer **[!UICONTROL Profile only]**&#x200B;eller **[!UICONTROL Audience and profile]**&#x200B;synkroniseringstyper*. Välj ett partitions-ID för Marketo som är kopplat till den valda arbetsytan. Detta anger vilken huvudpartition i Marketo som ska ta emot exporterade data. Om du inte väljer en viss partition skickas dina data till partitionen **[!UICONTROL Default]** i Marketo.
