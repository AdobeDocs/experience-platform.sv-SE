...
description: Foresee-tillägget är ett undersökningsmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
# [!DNL Foresee]-tillägg {#foresee-extension}

## Översikt {#overview}

Konfigurera [!DNL ForeSee] produktdistributioner med hjälp av taggar.

[!DNL Foresee] är ett undersökningstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html).
...
Så här installerar du tillägget [!DNL Foresee]:
...
Mer information om alternativen för tilläggskonfigurationen finns på sidan [Foresee extension](https://exchange.adobe.com/experiencecloud.details.100164.html) på Adobe Exchange.
