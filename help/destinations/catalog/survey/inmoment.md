...
# [!DNL InMoment]-tillägg {#inmoment-extension}
...
[!DNL InMoment] är ett undersökningstillägg i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
Mer information om alternativen för tilläggskonfigurationen finns på [tilläggssidan för Google Universal Analytics](https://exchange.adobe.com/experiencecloud.details.100847.html) på Adobe Exchange.
