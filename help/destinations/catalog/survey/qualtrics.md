...
[!DNL Qualtrics Website Feedback] gör att ni kan engagera besökarna på webbplatsen med rätt budskap vid rätt tidpunkt. Vare sig du vill förbättra besökarupplevelsen med hjälp av webbplatsens feedbackenkäter eller öka konverteringsgraden, [!DNL Qualtrics Website Feedback] har täckt dig.
...
![Qualtrics Web site Feedback Extension](../../assets/catalog/survey/qualtrics/catalog.png)
...
Så här installerar du [!DNL Qualtrics Website Feedback] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [Qualtrics Website Feedback page on Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
