...
description: Tillägget för feedback på Qualtrics-webbplatsen är ett undersökningsmål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
Med [!DNL Qualtrics Website Feedback] kan du engagera besökarna på webbplatsen med rätt meddelande vid rätt tidpunkt. Oavsett om du vill förbättra besökarupplevelsen med webbplatsens feedbackenkäter eller öka konverteringen så har [!DNL Qualtrics Website Feedback] det som krävs.
...
[!DNL Qualtrics Website Feedback] är ett undersökningstillägg i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Qualtrics-webbplatsens feedbacktillägg](../../assets/catalog/survey/qualtrics/catalog.png)
...
Mer information om alternativ för tilläggskonfiguration och installationsstöd finns på sidan [Qualtrics Website Feedback på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
