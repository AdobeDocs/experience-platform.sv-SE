...
[!DNL Bizible] är ett e-posttillägg i [!DNL Adobe Experience Platform]. Mer information om Bizible finns i [Marketing Attribution](https://experienceleague.adobe.com/docs/bizible/using/introduction-to-bizible/overview-resources/marketing-attribution.html) i Bizible overview-resurserna.
