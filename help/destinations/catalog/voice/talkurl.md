...
[!DNL Talk URL Inbox] är en röst för kundens programtillägg i Adobe Experience Platform. Mer information om tilläggsfunktioner finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Tillägg för URL-inkorg](../../assets/catalog/voice/talkurl/catalog.png)
...
Så här installerar du [!DNL Talk URL Inbox] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [Prat URL-inkorgssida på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
