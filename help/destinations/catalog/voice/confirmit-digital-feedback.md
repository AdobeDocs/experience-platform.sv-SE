...
[!DNL Confirmit Digital Feedback] kan ni omvandla era webbplatstrafik till realtidsinsikter. Med [!DNL Confirmit], kan diskreta och målinriktade enkäter visas enligt dina önskemål, vilket uppmuntrar besökarna att ge feedback, som:
...
Så här installerar du [!DNL Confirmit] Tillägg för digital feedback:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [Bekräfta sidan för digital feedback på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
