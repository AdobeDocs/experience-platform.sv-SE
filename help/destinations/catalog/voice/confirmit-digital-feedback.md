...
description: Tillägget Bekräfta digital feedback är en röst för kundens mål i Adobe Experience Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan i Adobe Exchange.
...
Med lösningen [!DNL Confirmit Digital Feedback] kan du omvandla webbplatstrafiken till realtidsinsikter. Med [!DNL Confirmit] kan diskreta och målinriktade enkäter visas enligt dina önskemål, vilket uppmuntrar besökarna att ge feedback, som:

* Synpunkter på webbplatsen
* Transaktionstillfredsställelse
* Avsluta återgivningsorsak
* Information om att överge kundvagn
* Generell kundnöjdhet
* Och mycket mer

[!DNL Confirmit] Digital feedback är en röst för kundtillägget i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
Så här installerar du tillägget [!DNL Confirmit] för digital feedback:
