...
Distribuera [!DNL Medallia] snabbt och smidigt i era webbegenskaper. Tillägget gör det även möjligt att identifiera enkäthändelser, samla in kundfeedback i realtid via dataelement, använda det i regler för att personalisera kundupplevelsen och dela data med Adobe Analytics.
...
Så här installerar du [!DNL Medallia] tillägg:
...
Mer information om alternativ för tilläggskonfiguration och installationssupport finns i [Mediallia-sida på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
