...
Detta är tillägget Adobe Audience Manager Data Integration Library (implementering på klientsidan). Obs! Det här tillägget är inte avsett att användas för vidarebefordran på serversidan av [!DNL Adobe Analytics]-data. Använd tillägget [!DNL Adobe Analytics] för SSF. Viktigt: Från och med version 8.0 är DIL beroende av [!DNL Experience Cloud] ID-tjänsten, version 3.3 eller senare. Implementera både [!DNL Experience Cloud] ID-tjänsten och DIL för fullständiga [!DNL Audience Manager] dataintegreringsfunktioner.

[!DNL Audience Manager] DIL är ett tillägg för datahanteringsplattform (DMP) i [!DNL Adobe Experience Platform]. Mer information om tilläggsfunktioner finns på sidan [Audience Manager-tillägg](../../../tags/extensions/client/audience-manager/overview.md) i taggdokumentationen.
