...
![Adobe Campaign Managed Cloud Services målinformationsformulär med fält för namn, beskrivning, instansval, målmappning och synkroniseringstyp.](../../assets/catalog/email-marketing/adobe-campaign-managed-services/destination-details.png)
...
1. Identifiera obligatoriska attribut och dedupliceringsnycklar. Observera att värden i attribut som är markerade som&quot;Obligatorisk&quot; eller&quot;Avdupliceringsnyckel&quot; inte kan vara null.
   ...
   * [En dedupliceringsnyckel](../../ui/activate-batch-profile-destinations.md#mandatory-attributes) är en primärnyckel som fastställer identiteten som användarna vill att deras profiler ska dedupliceras med.
   ...
   ![Skärm för attributmappning som visar XDM-källfält mappade till Adobe Campaign-målfält, med obligatoriska nyckelindikatorer och nyckelindikatorer för deduplicering.](../../assets/catalog/email-marketing/adobe-campaign-managed-services/mapping.png)
...
![Adobe Campaign Audience - visa skärmen för inläsningsjobb som har aktiverats från Adobe Experience Platform.](../../assets/catalog/email-marketing/adobe-campaign-managed-services/campaign-jobs.png)
...
![Listvy för målgrupper i Adobe Campaign AEP som visar exporterade målgrupper från Experience Platform som är tillgängliga under Profil och mål.](../../assets/catalog/email-marketing/adobe-campaign-managed-services/campaign-audiences.png)
