...
Tjänsten [!DNL Kinesis Data Streams] av [!DNL Amazon Web Services] samlar in och bearbetar stora dataströmmar i realtid.
...
* **[!DNL Amazon Web Services]åtkomstnyckel och hemlig nyckel**: Generera ett [!DNL Amazon Web Services]-par i `access key - secret access key` som ger Experience Platform åtkomst till ditt [!DNL Amazon Kinesis]-konto. Läs mer i [Amazon Web Services-dokumentationen](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html).
