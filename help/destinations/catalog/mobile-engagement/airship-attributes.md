...
Bläddra till **[!UICONTROL Destinations]** kategorin i **[!UICONTROL Catalog]**> **[!UICONTROL Mobile Engagement]** . Markera **[!DNL Airship Attributes]** och markera sedan **[!UICONTROL Configure]**.
...
I **[!UICONTROL Destinations > Browse]** väljer du det [!DNL Airship Attributes] mål där du vill aktivera segmenten.
...
Välj **[!UICONTROL Activate]**. I **[!UICONTROL Activate destination]** arbetsflödet på **[!UICONTROL Select Segments]** sidan väljer du vilka segment som ska skickas till [!DNL Airship Attributes].
