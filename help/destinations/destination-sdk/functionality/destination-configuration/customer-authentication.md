...
Konfigurera [!DNL OAuth2]-avsnittet via `customerAuthenticationConfigurations`-slutpunkten så som visas nedan för att konfigurera `/destinations`-autentisering för ditt mål:
...
Konfigurera [!DNL Amazon S3]-avsnittet via `customerAuthenticationConfigurations`-slutpunkten så som visas nedan för att konfigurera `/destinations`-autentisering för ditt mål:
...
Konfigurera parametern [!DNL Azure Blob] i slutpunkten `customerAuthenticationConfigurations` så som visas nedan om du vill konfigurera `/destinations`-autentisering för ditt mål:
...
När du konfigurerar autentiseringstypen [!DNL Azure Data Lake Storage] måste användare ange Azure Service Principal-autentiseringsuppgifter och innehavarinformation.
...
Konfigurera parametern [!DNL Azure Data Lake Storage] i slutpunkten `customerAuthenticationConfigurations` så som visas nedan om du vill konfigurera `/destinations`-autentisering (ADLS) för ditt mål:
...
## SFTP med lösenordsautentisering {#sftp-password-auth}
...
## SFTP med autentisering med SSH-nyckel {#sftp-ssh-key-auth}
...
Konfigurera parametern [!DNL Google Cloud Storage] i slutpunkten `customerAuthenticationConfigurations` så som visas nedan om du vill konfigurera `/destinations`-autentisering för ditt mål:
