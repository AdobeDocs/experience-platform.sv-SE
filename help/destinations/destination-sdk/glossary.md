...
**Målinstans**: En specifik konfiguration av en destinationskonfiguration i Adobe Experience Platform, som skapas och hanteras via Experience Platform användargränssnitt. Den innehåller alla nödvändiga parametrar och autentiseringsuppgifter för att ansluta och skicka data till målet. När du har upprättat anslutningen till målet kan du hämta målinstans-ID:t när du [bläddrar i en anslutning till målet](/help/destinations/ui/destination-details-page.md).
