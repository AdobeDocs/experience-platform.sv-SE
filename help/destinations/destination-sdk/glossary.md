...
# [!DNL Adobe Experience Platform] Destination SDK-ordlista

I den här ordlistan finns definitioner av termer som används i Destination SDK. Andra [!DNL Adobe Experience Platform]-termer finns i [Experience Platform-ordlistan](/help/landing/glossary.md).
...
**Slutpunkt för målkonfiguration**: En slutpunkt för målkonfiguration i [!DNL Adobe Experience Platform], särskilt API-slutpunkten `/authoring/destinations` , skapar, hämtar, uppdaterar och tar bort konfigurationer för mål. Dessa konfigurationer definierar hur data från [!DNL Adobe Experience Platform] levereras till olika externa system eller mål, som marknadsföringsplattformar, molnlagringstjänster eller andra slutpunkter för databearbetning. Läs mer om [tillgängliga konfigurationsalternativ](/help/destinations/destination-sdk/functionality/configuration-options.md#destination-configuration) och se [referensdokumentationen](/help/destinations/destination-sdk/authoring-api/destination-configuration/create-destination-configuration.md).

**Målinstans**: En specifik konfiguration av en målkonfiguration i [!DNL Adobe Experience Platform], som skapas och hanteras via Experience Platform-gränssnittet. Den innehåller alla nödvändiga parametrar och autentiseringsuppgifter för att ansluta och skicka data till målet. När du har upprättat anslutningen till målet kan du hämta målinstans-ID:t när du [bläddrar i en anslutning till målet](/help/destinations/ui/destination-details-page.md).
