...
Nyttolasten nedan innehåller en allmän [!DNL Amazon S3]-konfiguration med fördefinierade standardkonfigurationsparametrar för [&#x200B; CSV-filformatering](../../functionality/destination-server/file-formatting.md) som användare kan definiera i Experience Platform-gränssnittet.
