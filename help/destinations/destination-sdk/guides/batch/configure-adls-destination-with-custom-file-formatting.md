...
Genom att läsa den här artikeln kan du nu skapa ett anpassat [!DNL Azure Data Lake Storage]-mål med hjälp av Destination SDK. Därefter kan ditt team använda [aktiveringsarbetsflödet för filbaserade mål](../../../ui/activate-batch-profile-destinations.md) för att exportera data till målet.
