...
title: (Beta) Konfigurera ett Azure Data Lake Storage-mål med anpassade filformateringsalternativ och anpassad filnamnskonfiguration.
...
# (Beta) Konfigurera en [!DNL Azure Data Lake Storage] mål med anpassade filformateringsalternativ och anpassad filnamnskonfiguration
...
Nedan finns en allmän [!DNL Azure Data Lake Storage] konfiguration, med anpassad [CSV-filformatering](../../server-and-file-configuration.md#file-configuration) konfigurationsparametrar som användare kan definiera i användargränssnittet för Experience Platform.
...
![Skärminspelning som visar målkatalogsidan med ett valt målkort.](../../assets/adls-destination-card.gif)
