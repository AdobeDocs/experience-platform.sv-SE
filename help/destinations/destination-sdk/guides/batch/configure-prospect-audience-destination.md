...
Innan du går vidare till stegen som beskrivs nedan kan du läsa sidan [Komma igång](../../getting-started.md) för Destination SDK om du vill ha information om hur du hämtar nödvändiga autentiseringsuppgifter och andra krav för att arbeta med Destination SDK API:er.
...
Du kan nu använda Destination SDK för att skapa ett anpassat [!DNL Amazon S3]-mål för att exportera potentiella målgrupper.
