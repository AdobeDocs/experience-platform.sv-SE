...
# Konfigurera ett [!DNL Azure Blob Storage]-mål med anpassade filformateringsalternativ och konfiguration av anpassat filnamn

## Översikt {#overview}

På den här sidan beskrivs hur du använder Destination SDK för att konfigurera ett [!DNL Azure Blob Storage]-mål med anpassade [filformateringsalternativ](configure-file-formatting-options.md) och en anpassad [filnamnskonfiguration](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
Nyttolasten nedan innehåller en generisk Azure Blob-konfiguration med anpassade [CSV-filformateringsparametrar](../../functionality/destination-server/file-formatting.md) som användare kan definiera i användargränssnittet för Experience Platform.
...
![Skärminspelning som visar målkatalogsidan med ett valt målkort.](../../assets/guides/batch/blob-destination-card.gif)
...
Genom att läsa den här artikeln kan du nu skapa ett anpassat [!DNL Azure Blob Storage]-mål med hjälp av Destination SDK. Därefter kan ditt team använda [aktiveringsarbetsflödet för filbaserade mål](../../../ui/activate-batch-profile-destinations.md) för att exportera data till målet.
