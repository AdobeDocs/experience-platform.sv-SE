...
Nyttolasten nedan innehåller en allmän Azure-blobkonfiguration med anpassade [CSV-filformateringsparametrar](../../functionality/destination-server/file-formatting.md) som användare kan definiera i Experience Platform-gränssnittet.
...
Du kan nu skapa ett anpassat [!DNL Azure Blob Storage]-mål med Destination SDK. Därefter kan ditt team använda [aktiveringsarbetsflödet för filbaserade mål](../../../ui/activate-batch-profile-destinations.md) för att exportera data till målet.
