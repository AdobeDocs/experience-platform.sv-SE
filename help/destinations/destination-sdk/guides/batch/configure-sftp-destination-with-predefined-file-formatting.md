...
Nyttolasten nedan innehåller en allmän SFTP-konfiguration, med fördefinierade standardkonfigurationsparametrar för [CSV-filformatering](../../functionality/destination-server/file-formatting.md) som användare kan definiera i Experience Platform-gränssnittet.
...
Nu vet du hur du skapar ett anpassat SFTP-mål med Destination SDK. Därefter kan ditt team använda [aktiveringsarbetsflödet för filbaserade mål](../../../ui/activate-batch-profile-destinations.md) för att exportera data till målet.
