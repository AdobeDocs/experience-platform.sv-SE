...
*Lägg till ett stycke om hur data exporteras till målet. Detta hjälper kunden att se till att de är korrekt integrerade med er destination. Du kan till exempel skriva ett exempel på JSON som den nedan. Eller så kan ni tillhandahålla skärmbilder och information från målgränssnittet som visar hur kunderna förväntar sig att målgrupperna ska fylla i målplattformen.*
