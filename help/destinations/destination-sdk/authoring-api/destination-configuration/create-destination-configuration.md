...
| `identityNamespaces.externalId.acceptsCustomNamespaces` | Boolean | Anger om kunderna kan mappa identiteter som tillhör [anpassade namnutrymmen](/help/identity-service/features/namespaces.md#create-namespaces) till identiteten som du konfigurerar. |
