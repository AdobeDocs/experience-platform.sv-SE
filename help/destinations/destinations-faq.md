...
### Hur lång tid tar det för Facebook att bearbeta information från Adobe Experience Platform? {#facebook-processing-time}
...
### Stöder Adobe Experience Platform-integreringen med [!DNL Facebook Custom Audiences] diskvalificering av användare från en målgrupp när de inte längre är kvalificerade för det? {#facebook-disqualify-users}
...
### Måste jag använda Experience Platform Web SDK för att skicka målgrupper och attribut till Adobe Target? {#target-web-sdk}

+++Svar
Nej, det krävs inte att Web SDK aktiverar målgrupper för [Adobe Target](catalog/personalization/adobe-target-connection.md).
...
### Finns det någon gräns för hur många attribut jag kan skicka från kunddataplattformen i realtid till Adobe Target eller en anpassad Personalization-destination? {#target-attributes-limit}
...
### Var kan jag se de aktiverade attributen i Adobe Target? {#target-activated-attributes-location}
...
### Vad händer om jag tar bort ett Adobe Target-mål? {#delete-target-destination}
...
### Jag kan bara ha en kopplingsregel som är aktiv i farten. Kan jag bygga målgrupper som använder en annan sammanslagningspolicy och ändå skicka dem till Adobe Target som direktuppspelade målgrupper? {#edge-merge-policy}
