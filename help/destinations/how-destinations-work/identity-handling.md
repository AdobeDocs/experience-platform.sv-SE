...
[Personalization-mål (eller kantmål)](/help/destinations/destination-types.md#edge-personalization-destinations) (till exempel: [!DNL Adobe Target], [!DNL Custom Personalization]) kräver inte något identitetsval i aktiveringsarbetsflödet eftersom integreringen är en profilsökning. Klienten ([!DNL Target], [!DNL Web SDK] eller andra) frågar efter [[!UICONTROL Edge]](/help/collection/home.md) och hämtar den profilinformation som krävs för anpassning på plats.
