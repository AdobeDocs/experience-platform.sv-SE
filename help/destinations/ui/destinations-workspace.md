...
* Välj för att visa **[!UICONTROL Connections]** och/eller **[!UICONTROL Extensions]**. Mer information om skillnaden mellan de två kategorierna finns i [Måltyper och kategorier](../destination-types.md).
...
>[!TIP]
>
>Använd knappen ![](../assets/ui/workspace/add-data-symbol.png) Lägg till data i **[!UICONTROL Platform]** kolumnen för att skapa en ny målanslutning för det kontot.
...
| [!UICONTROL Username] | Användarnamnet som du valde i [målguiden](../catalog/email-marketing/overview.md#connect-destination)för anslutning. |
...
Dessutom kan du redigera eller uppdatera din kontoinformation. Klicka på knappen ![](../assets/ui/workspace/pencil-icon.png) Redigera konto i **[!UICONTROL Platform]** kolumnen om du vill redigera kontoinformationen.
...
>[!TIP]
>
>Använd knappen ![](../assets/ui/workspace/add-data-symbol.png) Lägg till data i **[!UICONTROL Name]** kolumnen för att aktivera ytterligare segment för det målet.
...
| [!UICONTROL Status] | `Active` eller `Inactive`. Anger om data för närvarande aktiveras till det här målet. Information om hur du redigerar status finns i [Inaktivera aktivering](./activate-destinations.md#disable-activation). |
