...
Mer information om schemaläggningssteget finns i självstudiekursen [för export av datauppsättningar](/help/destinations/api/export-datasets.md#export-datasets-by-using-the).
