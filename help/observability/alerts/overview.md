...
| --- | --- |
| **Mått** | En observationsförmåga [mått](../api/metrics.md#available-metrics) vars värde utlöser aviseringen, t.ex. antalet misslyckade batchingshändelser (`timeseries.ingestion.dataset.batchfailed.count`). |
...
| Lös aviseringar* | Gör att du kan lösa utlösta varningar via fliken [!UICONTROL Alerts]. |

{style=&quot;table-layout:auto&quot;}

**För att komma åt fliken [!UICONTROL Alerts] måste du även beviljas behörigheten Visa aviseringar i kombination med en av de andra behörigheterna.*
...
Med behörigheten Visa aviseringar kan du visa mottagna aviseringar genom att välja klockikonen (![Bell Icon](../images/alerts/overview/icon.png)) i det övre högra hörnet.

![](../images/alerts/overview/ui.png)

På fliken [!UICONTROL Alerts] i användargränssnittet kan enskilda användare dessutom prenumerera på särskilda larmtyper och administratörer kan aktivera eller inaktivera varningsregler helt och hållet. Mer information om hur du hanterar aviseringar finns i [användargränssnittshandboken](./ui.md).
