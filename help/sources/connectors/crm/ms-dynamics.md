...
[!DNL Experience Platform] har stöd för inmatning av data från ett CRM-system från tredje part. Stöd för CRM-leverantörer innefattar [!DNL Microsoft Dynamics].
...
## Anslut [!DNL Microsoft Dynamics] till [!DNL Platform] använda API:er
