...
topic: overview
description: Dokumentationen nedan innehåller information om hur du ansluter Salesforce Service Cloud till plattformen med hjälp av API:er eller användargränssnittet.
...
# (Beta)- [!DNL Salesforce Service Cloud] anslutning
...
[!DNL Experience Platform] har stöd för inmatning av data från ett lyckat system från tredje part. Support för leverantörer av nöjda kunder är bland annat [!DNL Salesforce Service Cloud].
...
## Ansluta [!DNL Salesforce Service Cloud ]till [!DNL Platform] med API:er
...
## Ansluta [!DNL Salesforce Service Cloud] till [!DNL Platform] användargränssnittet
