...
[!DNL Experience Platform] har stöd för inmatning av data från ett lyckat system från tredje part. Bland leverantörerna av nöjda kunder finns [!DNL Salesforce Service Cloud].
...
## Anslut [!DNL Salesforce Service Cloud ]till [!DNL Platform] använda API:er
