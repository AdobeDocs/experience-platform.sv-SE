...
topic: overview
description: Dokumentationen nedan innehåller information om hur du ansluter ServiceNow till plattformen med API:er eller användargränssnittet.
...
# (Beta)- [!DNL ServiceNow] anslutning
...
[!DNL Experience Platform] har stöd för inmatning av data från ett lyckat system från tredje part. Support för leverantörer av nöjda kunder är bland annat [!DNL ServiceNow].
...
## Ansluta [!DNL ServiceNow] till [!DNL Platform] användargränssnittet
