...
>[!NOTE]
>
>Kopplingen [!DNL HP Vertica] är i betaversion. Mer information om hur du använder betatecknade anslutningar finns i [Källor-översikten](../../home.md#terms-and-conditions) .
...
Olika typer av tredjepartsdatabaser stöds, bland annat relational, NoSQL och data warehouse. Stöd för databasleverantörer omfattar [!DNL HP Vertica].
...
- [Skapa en HP Vertica-koppling med API:t för Flow Service](../../tutorials/api/create/databases/hp-vertica.md)
...
## Ansluta [!DNL HP Vertica] till [!DNL Platform] användargränssnittet

- [Skapa en HP Vertica-källkoppling i användargränssnittet](../../tutorials/ui/create/databases/hp-vertica.md)
