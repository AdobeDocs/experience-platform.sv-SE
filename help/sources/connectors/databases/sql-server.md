...
# (Beta) [!DNL Microsoft] SQL Server-anslutning
...
## Anslut [!DNL Microsoft] SQL Server till [!DNL Platform] API:er
...
## Ansluta [!DNL Microsoft] SQL Server till [!DNL Platform] användargränssnittet
