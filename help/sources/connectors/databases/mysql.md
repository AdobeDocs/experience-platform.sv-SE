...
Experience Platform har stöd för att importera data från en tredjepartsdatabas. Platform kan ansluta till olika typer av databaser, till exempel relational, NoSQL eller data warehouse. Stöd för databasleverantörer är bland annat MySQL.

Dokumentationen nedan innehåller information om hur du ansluter MySQL till Platform med API:er eller användargränssnittet:

## Anslut MySQL till Platform med API:er
...
## Anslut MySQL till Platform med användargränssnittet
