...
[!DNL Experience Platform] har stöd för inmatning av data från en tredjepartsdatabas. [!DNL Platform] kan ansluta till olika typer av databaser, till exempel relational, NoSQL eller data warehouse. Stöd för databasproviders är [!DNL Google BigQuery].
...
## Anslut [!DNL Google BigQuery] till [!DNL Platform] med användargränssnittet
