...
topic: overview
description: Dokumentationen nedan innehåller information om hur du ansluter Google BigQuery till plattformen med hjälp av API:er eller användargränssnittet.
