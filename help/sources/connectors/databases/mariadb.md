...
topic: overview
description: Dokumentationen nedan innehåller information om hur du ansluter MariaDB till plattformen med API:er eller användargränssnittet.
...
Experience Platform har stöd för att importera data från en tredjepartsdatabas. [!DNL Platform] kan ansluta till olika typer av databaser, till exempel relational, NoSQL eller data warehouse. Stöd för databasleverantörer är bland annat [!DNL MariaDB].
...
## Ansluta [!DNL MariaDB] till [!DNL Platform] användargränssnittet
