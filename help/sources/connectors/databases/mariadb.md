...
Experience Platform har stöd för inmatning av data från en tredjepartsdatabas. Plattformen kan ansluta till olika typer av databaser, till exempel relationsdatabaser, NoSQL-databaser eller datalager. Stöd för databasleverantörer är MariaDB.

Dokumentationen nedan innehåller information om hur du ansluter MariaDB till plattformen med API:er eller användargränssnittet:

## Anslut MariaDB till plattformen med API:er
...
## Anslut MariaDB till plattformen med användargränssnittet
