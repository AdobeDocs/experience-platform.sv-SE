...
Experience Platform har stöd för inmatning av data från en tredjepartsdatabas. Plattformen kan ansluta till olika typer av databaser, till exempel relationsdatabaser, NoSQL-databaser eller datalager. Stöd för databasleverantörer innefattar Oracle.

Dokumentationen nedan innehåller information om hur du ansluter Oracle till plattformen med API:er:
