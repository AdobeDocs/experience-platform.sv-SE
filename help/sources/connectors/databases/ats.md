...
title: Azure Table Storage-koppling
topic: overview
description: Dokumentationen nedan innehåller information om hur du ansluter Azure Table Storage till plattformen med API:er eller användargränssnittet.
...
# (Beta)- [!DNL Azure Table Storage] anslutning
...
[!DNL Experience Platform] har stöd för inmatning av data från en tredjepartsdatabas. [!DNL Platform] kan ansluta till olika typer av databaser, till exempel relational, NoSQL eller data warehouse. Stöd för databasleverantörer är bland annat [!DNL Azure Table Storage].
...
- [Skapa en Azure Table Storage-koppling med API:t för Flow Service](../../tutorials/api/create/databases/ats.md)
...
## Ansluta [!DNL Azure Table Storage] till [!DNL Platform] användargränssnittet
