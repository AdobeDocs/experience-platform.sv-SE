...
| Source | Sökväg till mål-XDM-fält | Anteckningar |
| --- | --- | --- |
...
Mer information om klassen XDM finns i [XDM Business Account Details overview](../../../../xdm/classes/b2b/business-account.md).
...
Läs översikten över klassen [XDM Business Opportunity Person Relation](../../../../xdm/classes/b2b/business-opportunity-person-relation.md) för mer information om klassen XDM.
...
Läs översikten över klassen [XDM Business Campaign](../../../../xdm/classes/b2b/business-campaign.md) för mer information om klassen XDM. Mer information om XDM-fältgrupper finns i guiden [XDM Business Campaign details schema field group](../../../../xdm/field-groups/b2b-campaign/details.md) .
...
Läs översikten [XDM Business Campaign Members](../../../../xdm/classes/b2b/business-campaign-members.md) för mer information om klassen XDM. Mer information om XDM-fältgrupper finns i [XDM Business Campaign Member details schema field group](../../../../xdm/field-groups/b2b-campaign/details.md) document.
...
Mer information om klassen XDM finns i [XDM Business Account Person Relation](../../../../xdm/classes/b2b/business-account-person-relation.md).
...
Genom att läsa det här dokumentet har du fått information om mappningsförhållandet mellan [!DNL Salesforce]-källfält och deras motsvarande XDM-fält. Mer information finns i dokumentationen om [att skapa en [!DNL Salesforce] källanslutning](../../../connectors/crm/salesforce.md).
