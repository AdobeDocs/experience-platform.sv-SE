...
Du kan upprätta namnutrymmet `CORE` genom att ange besökarens Experience Cloud-id med [Identitet i datainsamling](/help/collection/identity/overview.md), [Mobile SDK](https://developer.adobe.com/client-sdks/documentation/mobile-core/identity/) eller [Experience Cloud ID Service API](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=sv-SE).
