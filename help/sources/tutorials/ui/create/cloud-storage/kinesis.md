...
Under **[!UICONTROL Cloud Storage]** kategori, välj **[!UICONTROL Amazon Kinesis]**. Om det här är första gången du använder den här kopplingen väljer du **[!UICONTROL Configure]**. Annars väljer du **[!UICONTROL Add data]** för att skapa en ny [!DNL Kinesis] koppling.
...
Välj [!DNL Kinesis] konto som du vill ansluta till och välj **[!UICONTROL Next]** för att fortsätta.
