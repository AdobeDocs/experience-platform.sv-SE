...
> [!NOTE]
> Azure Data Explorer-kopplingen är i betaversion. Mer information om hur du använder betatecknade anslutningar finns i [Källor-översikten](../../../../home.md#terms-and-conditions) .

Källkopplingar i Adobe Experience Platform ger möjlighet att importera externt källdata på schemalagd basis. I den här självstudiekursen beskrivs hur du skapar en Azure Data Explorer-källkoppling (kallas nedan&quot;Data Explorer&quot;) med Platform användargränssnitt.
...
När du har samlat in dina inloggningsuppgifter kan du följa stegen nedan för att skapa ett nytt Data Explorer-konto för att ansluta till Platform.
...
Genom att följa den här självstudiekursen har du upprättat en anslutning till ditt Data Explorer-konto. Du kan nu fortsätta med nästa självstudiekurs och [konfigurera ett dataflöde för att hämta data till Platform](../../dataflow/databases.md).