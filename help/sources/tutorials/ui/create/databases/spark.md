...
Source-anslutningar i Adobe Experience Platform gör det möjligt att importera externa data på schemalagd basis. I den här självstudiekursen beskrivs hur du skapar en [!DNL Apache Spark] på [!DNL Azure HDInsights]-källkoppling med användargränssnittet i [!DNL Platform].
...
När du har samlat in de nödvändiga inloggningsuppgifterna kan du följa stegen nedan för att länka ditt [!DNL Spark]-konto till [!DNL Platform].
