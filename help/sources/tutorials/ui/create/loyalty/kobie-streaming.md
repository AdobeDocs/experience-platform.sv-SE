---
title: Direktuppspela data från Kobie till Experience Platform med användargränssnittet
description: Lär dig hur du direktuppspelar data från Kobie till Adobe Experience Platform med användargränssnittet.
badge: Beta
hide: true
hidefromtoc: true
...
# Strömma data från [!DNL Kobie] till Experience Platform med användargränssnittet

Läs den här vägledningen när du vill lära dig hur du ansluter och direktuppspelar data från [!DNL Kobie] till Adobe Experience Platform med hjälp av källarbetsytan i användargränssnittet.
...
>[!IMPORTANT]
>
>Läs [[!DNL Kobie] översikten](../../../../connectors/loyalty/kobie.md) om du vill veta mer om nödvändiga åtgärder som du måste utföra innan du kan ansluta ditt konto till Experience Platform.
...
Om du vill strömma data från [!DNL Kobie] markerar du **[!UICONTROL Kobie Streaming Events]**-källkortet under *[!UICONTROL Loyalty]* och väljer sedan **[!UICONTROL Add data]**.
...
![Källkatalogen i användargränssnittet med händelsekortet för direktuppspelning från Kobie markerat.](../../../../images/tutorials/create/kobie/catalog.png)
...
![Steg för val av data i källarbetsflödet](../../../../images/tutorials/create/kobie/select-data.png)
...
![Gränssnittet för dataflödesinformation](../../../../images/tutorials/create/kobie/dataflow-details.png)
...
![Mappningssteget i arbetsflödet](../../../../images/tutorials/create/kobie/mapping.png)
...
![Granskningssteget i källarbetsflödet.](../../../../images/tutorials/create/kobie/review.png)
...
![URL:en för direktuppspelningsslutpunkten.](../../../../images/tutorials/create/kobie/streaming-endpoint.png)
