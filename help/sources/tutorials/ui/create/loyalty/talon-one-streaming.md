...
# Strömma [!DNL Talon.One]-data till Experience Platform med användargränssnittet
...
Läs den här vägledningen när du vill lära dig hur du ansluter och direktuppspelar data från [!DNL Talon.One] till Adobe Experience Platform med hjälp av källarbetsytan i användargränssnittet.
...
Om du vill strömma data från [!DNL Talon.One] markerar du **[!UICONTROL Talon.One Streaming Events]**-källkortet under *[!UICONTROL Loyalty]* och väljer sedan **[!UICONTROL Add data]**.
...
![Källkatalogen i användargränssnittet med händelsekortet Talon.One Streaming Events valt.](../../../../images/tutorials/create/talon-one-streaming/catalog.png)
...
![Steg för val av data i källarbetsflödet](../../../../images/tutorials/create/talon-one-streaming/select-data.png)
...
![Gränssnittet för dataflödesinformation](../../../../images/tutorials/create/talon-one-streaming/dataflow-details.png)
...
![Mappningsgränssnittet för Talon.One-direktuppspelning.](../../../../images/tutorials/create/talon-one-streaming/mapping.png)
...
![Granskningssteget i källarbetsflödet.](../../../../images/tutorials/create/talon-one-streaming/review.png)
...
![URL:en för direktuppspelningsslutpunkten.](../../../../images/tutorials/create/talon-one-streaming/streaming-endpoint.png)
