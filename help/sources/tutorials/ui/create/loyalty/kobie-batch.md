---
title: Importera batchdata från Kobie till Experience Platform med användargränssnittet
description: Lär dig hur du importerar batchdata från Kobie till Adobe Experience Platform med användargränssnittet.
badge: Beta
hide: true
hidefromtoc: true
...
# Infoga batchdata från [!DNL Kobie] till Experience Platform med användargränssnittet

Läs den här självstudiekursen om du vill lära dig hur du importerar gruppdata från ditt [!DNL Kobie]-konto till Adobe Experience Platform med hjälp av källarbetsytan i användargränssnittet.
...
Om du vill importera data från [!DNL Kobie] väljer du **[!UICONTROL Kobie Batch Source Connector]**-källkortet under *[!UICONTROL Loyalty]* och sedan **[!UICONTROL Add data]**.
...
Om du vill skapa ett nytt konto för källan [!DNL Kobie] väljer du **[!UICONTROL New account]** och anger ett namn och en valfri beskrivning för kontot. Ange sedan din [!DNL Kobie]-domän och din [!UICONTROL Kobie Management API Key]. När du är klar väljer du **[!UICONTROL Connect to source]** och tillåt en stund så att anslutningen kan upprättas.



### Använd ett befintligt konto

Om du vill använda ett befintligt konto markerar du **[!UICONTROL Existing account]** och väljer det [!DNL Kobie]-konto som du vill använda i kontogränssnittet.
...
>[!IMPORTANT]
>
>Mer information om hur du mappar dina [!DNL Kobie]-källdata finns i [[!DNL Kobie] översikt]
