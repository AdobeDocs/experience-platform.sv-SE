...
* **Intervall**: När du har valt en frekvens kan du konfigurera intervallinställningen för att upprätta tidsramen mellan varje intag. Om du t.ex. anger din frekvens som dag och konfigurerar intervallet till 15, kommer dataflödet att köras var 15:e dag. Intervall kan inte anges till noll och måste anges till minst 15.
