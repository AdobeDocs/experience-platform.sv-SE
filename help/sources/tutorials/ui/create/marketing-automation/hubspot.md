...
title: Skapa en HubSpot Source Connection i användargränssnittet
type: Tutorial
...
Om du använder nya autentiseringsuppgifter väljer du **[!UICONTROL New account]**. Ange ett namn, en valfri beskrivning och dina [!DNL HubSpot]-inloggningsuppgifter på det indataformulär som visas. När du är klar väljer du **[!UICONTROL Connect]** och tillåt sedan lite tid för att upprätta den nya anslutningen.

![anslut](../../../../images/tutorials/create/hubspot/connect.png)

### Befintligt konto

Om du vill ansluta ett befintligt konto markerar du det [!DNL HubSpot]-konto du vill ansluta till och väljer sedan **[!UICONTROL Next]** för att fortsätta.
