...
title: Konfigurera ett dataflöde för en molnlagringskontakt i användargränssnittet
topic: overview
...
# Konfigurera ett dataflöde för en molnlagringskontakt i användargränssnittet
...
När ditt molnlagringsdataflöde har skapats kan du övervaka de data som hämtas genom det. Följ stegen nedan för att komma åt dataflödets datauppsättningsövervakare.

Klicka på fliken *Bläddra* på arbetsytan **Källor** för att visa dina basanslutningar. I listan som visas söker du efter anslutningen som innehåller det dataflöde som du vill övervaka genom att klicka på dess namn.
...
Nedanför diagrammet visas en lista med batchar som har importerats till datauppsättningen, med deras status (slutförd eller misslyckades) och antalet poster som har importerats. Om en grupp hämtas till en profilaktiverad datauppsättning visas antalet inkapslade profiler och identiteter.

Du kan visa mer information om en listad grupp genom att klicka på dess ID.
