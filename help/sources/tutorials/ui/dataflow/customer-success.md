...
Den här självstudiekursen kräver dessutom att du redan har skapat ett konto för kundframgångar. En lista med självstudiekurser för att skapa olika kundtjänstkopplingar i användargränssnittet finns i [översikten över källanslutningar](../../../home.md).

## Markera data

När du har skapat en kundframgångskontakt visas **[!UICONTROL Select data]**-steget, som ger ett interaktivt gränssnitt där du kan utforska din filhierarki.
...
På skärmen **[!UICONTROL Authentication]** markerar du namnet på kontot som är associerat med det dataflöde som du vill inaktivera.
