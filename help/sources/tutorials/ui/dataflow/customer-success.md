...
När du har skapat ett bra källkonto för kunden **[!UICONTROL Add data]** visas, så att du får ett gränssnitt där du kan utforska kundens framgångskällkontos tabellhierarki.
...
Genom att följa den här självstudiekursen har du skapat ett dataflöde som kan överföra data från din Customer Success Source till Platform. Inkommande data kan nu användas av underordnade [!DNL Platform] tjänster som [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
