---
keywords: Experience Platform;home;populära topics;analytics;mixpanel
...
Ett dataflöde är en schemalagd aktivitet som hämtar och importerar data från en källa till en datauppsättning i Adobe Experience Platform. I den här självstudiekursen beskrivs hur du skapar ett dataflöde för en analyskälla med hjälp av användargränssnittet i Experience Platform.

>[!NOTE]
>
>För att kunna skapa ett dataflöde måste du redan ha ett autentiserat konto hos källan [!DNL Mixpanel]. Mer information finns i självstudiekursen [Skapa en [!DNL Mixpanel] källanslutning i användargränssnittet](../../ui/create/analytics/mixpanel.md).
...
Genom att följa den här självstudiekursen har du skapat ett dataflöde för att överföra data från analyskällan till Experience Platform. Inkommande data kan nu användas av [!DNL Experience Platform]-tjänster längre fram i kedjan, till exempel [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
