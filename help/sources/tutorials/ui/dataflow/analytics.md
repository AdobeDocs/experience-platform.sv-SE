...
Genom att följa den här självstudiekursen har du skapat ett dataflöde för att överföra data från analyskällan till plattformen. Inkommande data kan nu användas av [!DNL Platform]-tjänster längre fram i kedjan, till exempel [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
