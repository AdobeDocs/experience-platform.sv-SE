...
När ni har skapat ert källkonto för automatiserad marknadsföring har **[!UICONTROL Add data]** visas, så att du får ett gränssnitt där du kan utforska det automatiserade källkontots tabellhierarki.
