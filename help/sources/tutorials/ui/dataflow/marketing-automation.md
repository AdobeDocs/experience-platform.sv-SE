---
keywords: Experience Platform;home;populära topics;marketing automation connector
solution: Experience Platform
title: Skapa ett dataflöde med hjälp av en Source för marknadsföringsautomatisering i användargränssnittet
type: Tutorial
description: Ett dataflöde är en schemalagd aktivitet som hämtar och importerar data från en källa till en Experience Platform-datauppsättning. I den här självstudiekursen beskrivs hur du skapar ett dataflöde för en källa för automatiserad marknadsföring med Experience Platform UI.
...
# Skapa ett dataflöde med hjälp av en källa för automatiserad marknadsföring i användargränssnittet

Ett dataflöde är en schemalagd aktivitet som hämtar och importerar data från en källa till en datauppsättning i Adobe Experience Platform. I den här självstudiekursen beskrivs hur du skapar ett dataflöde för en källa för automatiserad marknadsföring med Experience Platform användargränssnitt.

>[!NOTE]
>
>* För att kunna skapa ett dataflöde måste du redan ha ett autentiserat konto med en källa för automatiserad marknadsföring. En lista med självstudiekurser för att skapa olika källkonton för automatiserad marknadsföring i användargränssnittet finns i [källöversikten](../../../home.md#marketing-automation).
...
När du har skapat ditt källkonto för automatiserad marknadsföring visas steget **[!UICONTROL Add data]**, som ger dig ett gränssnitt där du kan utforska källkontots tabellhierarki för automatiserad marknadsföring.
...
Genom att följa den här självstudiekursen har du skapat ett dataflöde som kan hämta data från din källa för automatiserad marknadsföring till Experience Platform. Inkommande data kan nu användas av [!DNL Experience Platform]-tjänster längre fram i kedjan, till exempel [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
