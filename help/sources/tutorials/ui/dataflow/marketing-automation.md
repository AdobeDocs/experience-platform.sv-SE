...
Ett dataflöde är en schemalagd aktivitet som hämtar och importerar data från en källa till en datauppsättning i Adobe Experience Platform. I den här självstudiekursen beskrivs hur du skapar ett dataflöde för en källa för automatiserad marknadsföring med hjälp av användargränssnittet för plattformen.
...
Genom att följa den här självstudiekursen har du skapat ett dataflöde som kan hämta data från din källa för automatiserad marknadsföring till Platform. Inkommande data kan nu användas av [!DNL Platform]-tjänster längre fram i kedjan, till exempel [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
