...
Den här självstudien kräver dessutom att du redan har skapat ett betalkonto. En lista med självstudiekurser för att skapa olika betalningsanslutningar i användargränssnittet finns i [översikt över källanslutningar](../../../home.md).

## Markera data

När du har skapat ditt betalkonto **[!UICONTROL Select data]** visas med ett interaktivt gränssnitt där du kan utforska din filhierarki.
