...
Ett dataflöde är en schemalagd åtgärd som hämtar och importerar data från en källa till en Adobe Experience Platform-datauppsättning. I den här självstudiekursen beskrivs hur du konfigurerar ett nytt dataflöde med ditt betalkonto.
...
Den här självstudien kräver dessutom att du redan har skapat ett betalkonto. En lista med självstudiekurser för att skapa olika betalningsanslutningar i användargränssnittet finns i [källanslutningsöversikten](../../../home.md).

## Markera data

När du har skapat ditt betalkonto visas steget *Välj data* , som ger ett interaktivt gränssnitt där du kan utforska din filhierarki.
...
Markera den katalog som du vill använda och välj sedan **Nästa**.
...
Flödesdetaljsteget för *datauppsättningen* visas, där du måste ange ett namn och en valfri beskrivning för datauppsättningsflödet. Välj **Nästa** när du är klar.
