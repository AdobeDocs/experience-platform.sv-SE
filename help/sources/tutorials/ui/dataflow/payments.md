...
Den här självstudien kräver dessutom att du redan har skapat ett betalkonto. En lista med självstudiekurser för att skapa olika betalningsanslutningar i användargränssnittet finns i [översikten över källanslutningsprogram](../../../home.md).

## Markera data

När du har skapat ditt betalkonto visas steget **[!UICONTROL Select data]**, som ger ett interaktivt gränssnitt där du kan utforska din filhierarki.
