...
title: Skapa ett dataflöde med hjälp av en källa för samtycke och inställningar i användargränssnittet
type: Tutorial
...
När du har skapat ditt källkonto för samtycke och inställningar kan du **[!UICONTROL Add data]** visas, där du får ett gränssnitt där du kan utforska ditt medgivande och ditt inställningskontos tabellhierarki.
