...
Den här självstudien kräver dessutom att du redan har skapat ett protokollkonto. En lista med självstudiekurser för att skapa olika protokollanslutningar i användargränssnittet finns i [översikt över källanslutningar](../../../home.md).

## Markera data

När du har skapat ett protokollkonto visas **[!UICONTROL Select data]** visas med ett interaktivt gränssnitt där du kan utforska din filhierarki.
