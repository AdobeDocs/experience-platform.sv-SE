...
Ett dataflöde är en schemalagd aktivitet som hämtar och importerar data från en källa till en datauppsättning från Adobe Experience Platform. I den här självstudiekursen beskrivs hur du konfigurerar ett nytt dataflöde med ditt protokollkonto.
...
Den här självstudien kräver dessutom att du redan har skapat ett protokollkonto. En lista med självstudiekurser för att skapa olika protokollanslutningar i användargränssnittet finns i [källanslutningsöversikten](../../../home.md).
...
Stegen visas där du måste ange ett namn och en valfri beskrivning för dataflödet. *[!UICONTROL Dataflow detail]* Steget visas. Klicka **[!UICONTROL Next]** när du är klar.
