...
När du har skapat ditt CRM-källkonto **[!UICONTROL Add data]** visas, där du får ett gränssnitt där du kan utforska CRM-kontots tabellhierarki.
...
I den här självstudiekursen har du skapat ett dataflöde som hämtar data från CRM-källan till plattformen. Inkommande data kan nu användas av underordnade [!DNL Platform] tjänster som [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
