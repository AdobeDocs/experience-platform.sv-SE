...
Den här självstudiekursen kräver dessutom att du redan har skapat ett CRM-konto. En lista med självstudiekurser för att skapa olika CRM-anslutningar i användargränssnittet finns i [översikten över källanslutningar](../../../home.md).
...
| Backfill | Ett booleskt värde som avgör vilka data som hämtas från början. Om **[!UICONTROL Backfill]** är aktiverat importeras alla aktuella filer i den angivna sökvägen under det första schemalagda intaget. Om **[!UICONTROL Backfill]** är inaktiverat importeras endast de filer som är inlästa mellan den första importkörningen och **[!UICONTROL Start time]**. Filer som lästs in före **[!UICONTROL Start time]** kommer inte att importeras. |
