...
Ett dataflöde är en schemalagd aktivitet som hämtar och importerar data från en källa till en [!DNL Platform] datauppsättning. I den här självstudiekursen beskrivs hur du konfigurerar ett nytt dataflöde med CRM-basanslutningen.
...
På arbetsytan _Källor_ väljer du den CRM-källa som du vill visa under *[!UICONTROL CRM]* kategorin. Välj *[!UICONTROL Connect Source]* att starta autentiseringsgränssnittet. Om du vill visa ett befintligt dataflöde väljer du *Befintligt konto* och väljer det konto som du vill komma åt.
...
I den här självstudiekursen har du skapat ett dataflöde för att hämta in data från en CRM och fått insikter om att övervaka datauppsättningar. Inkommande data kan nu användas av [!DNL Platform] tjänster längre fram i kedjan som [!DNL Real-time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
