...
När du har skapat ditt källkonto för annonsering **[!UICONTROL Add data]** visas med ett gränssnitt där du kan utforska tabellhierarkin för ditt annonskällkonto.
