...
Ett dataflöde är en schemalagd åtgärd som hämtar och importerar data från en källa till en Adobe Experience Platform-datauppsättning. I den här självstudiekursen beskrivs hur du konfigurerar ett nytt dataflöde med ditt annonskonto.
...
När du har skapat ditt annonskonto visas steget *Välj data* , som ger ett interaktivt gränssnitt där du kan utforska din filhierarki.
...
![schemaläggning](../../../images/tutorials/dataflow/advertising/schedule.png)
