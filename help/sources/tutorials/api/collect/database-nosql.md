...
title: Samla in data från en databas via källanslutningar och API:er
topic: overview
type: Tutorial
description: Den här självstudiekursen beskriver stegen för att hämta data från en databas och hämta dem till plattformen via källanslutningar och API:er.
...
# Samla in data från en databas via källanslutningar och API:er
...
| -------- | ----------- |
| `connectionId` | Anslutnings-ID för datakällan. |
...
I tidigare steg skapades ett ad hoc-XDM-schema för att strukturera källdata. För att källdata ska kunna användas i Platform måste ett målschema också skapas för att strukturera källdata efter dina behov. Målschemat används sedan för att skapa en plattformsdatauppsättning där källdata finns. Detta mål-XDM-schema utökar även klassen [!DNL XDM Individual Profile].
