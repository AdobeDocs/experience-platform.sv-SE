...
# Skapa ett dataflöde för betalningskällor med [!DNL Flow Service] API

I den här självstudiekursen beskrivs stegen för att hämta data från en betalningskälla och få dem till plattformen med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>För att kunna skapa ett dataflöde måste du redan ha ett giltigt [!DNL PayPal] grundläggande anslutnings-ID. Om du inte har det här ID:t kan du följa stegen för att [skapa en [!DNL PayPal] basanslutning](../create/payments/paypal.md) innan du försöker göra den här självstudiekursen.
