---
keywords: Experience Platform;hemmabruk;populära ämnen;automatiserad marknadsföring;Samla in automatiserade marknadsföringsdata
...
# Skapa ett dataflöde för källor för automatiserad marknadsföring med API:t [!DNL Flow Service]

I den här självstudiekursen beskrivs stegen för hur du hämtar data från en källa för automatiserad marknadsföring och överför dem till Experience Platform med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>* För att kunna skapa ett dataflöde måste du redan ha ett giltigt basanslutnings-ID med en källa för automatiserad marknadsföring. Om du inte har det här ID:t kan du se [Källöversikt](../../../home.md#marketing-automation) för en lista över källor för automatiserad marknadsföring som du kan skapa en basanslutning med.
...
Ett dataflöde används för att samla in data från källor och föra in dem i Experience Platform. För att kunna skapa ett dataflöde måste du först få de dataflödesspecifikationer som ansvarar för att samla in data för automatiserad marknadsföring.
...
Genom att följa den här självstudiekursen har du skapat en källanslutning för att samla in data från ett automatiserat marknadsföringssystem på schemalagd basis. Inkommande data kan nu användas av Experience Platform-tjänster längre fram i kedjan som [!DNL Real-Time Customer Profile] och [!DNL Data Science Workspace]. Mer information finns i följande dokument:
