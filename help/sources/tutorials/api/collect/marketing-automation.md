...
# Skapa ett dataflöde för källor för automatiserad marknadsföring med [!DNL Flow Service] API

Den här självstudiekursen handlar om hur du hämtar data från en källa för automatiserad marknadsföring och överför dem till plattformen med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
