...
Den här självstudiekursen beskriver stegen för att hämta data från en källa för automatiserad marknadsföring och föra dem till plattformen med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
