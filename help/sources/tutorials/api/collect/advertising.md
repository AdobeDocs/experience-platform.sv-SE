...
I den här självstudiekursen måste du ha information om filen som du vill hämta till Platform, inklusive filens sökväg och struktur. Om du inte har den här informationen kan du gå till självstudiekursen [där du utforskar ett annonsprogram med API:t för Flow Service](../../api/create/advertising/ads.md) innan du provar den här självstudiekursen.
