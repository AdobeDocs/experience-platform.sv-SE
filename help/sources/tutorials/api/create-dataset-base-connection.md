...
title: Skapa en Experience Platform-datauppsättningsbaserad anslutning med API:t för Flow Service
topic: overview
...
# Skapa en Experience Platform-datauppsättningsbaserad anslutning med API:t för Flow Service

Flow Service används för att samla in och centralisera kunddata från olika källor inom Adobe Experience Platform. Tjänsten tillhandahåller ett användargränssnitt och RESTful API som alla källor som stöds kan anslutas från.

För att kunna ansluta data från en tredjepartskälla till plattformen måste en datauppsättningsbasanslutning först upprättas.

I den här självstudien används API:t för Flow Service för att vägleda dig genom stegen för att skapa en datauppsättningsbasanslutning.
...
I följande avsnitt finns ytterligare information som du behöver känna till för att kunna ansluta till Data Lake med API:t för Flow Service.
...
Det första steget i att skapa en datauppsättningsbasanslutning är att hämta en uppsättning anslutningsspecifikationer från Flow Service.
...
I den här självstudiekursen har du skapat en datauppsättningsbasanslutning med API:t för Flow Service och fått anslutningens unika ID-värde. Du kan använda den här basanslutningen för att skapa en målanslutning. I följande självstudiekurser får du hjälp med att skapa en målanslutning, beroende på vilken typ av källanslutning du använder:
