...
# (Beta) Skapa ett dataflöde för en [!DNL OneTrust Integration] källa med [!DNL Flow Service] API
...
| `auth.params.` | Innehåller de autentiseringsuppgifter som krävs för att autentisera källan. Rotvärden och åtkomsttoken för att ansluta till API:t. |
| `auth.params.host` | Den miljö som [!DNL OneTrust Integration] data måste hämtas från. |
