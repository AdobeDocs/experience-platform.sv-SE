...
# Skapa en [!DNL Azure Synapse Analytics] basanslutning med [!DNL Flow Service] API
...
I den här självstudiekursen får du hjälp med att skapa en basanslutning för [!DNL Azure Synapse Analytics] (nedan kallad[!DNL Synapse]&quot;) med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
I följande avsnitt finns ytterligare information som du behöver känna till för att kunna ansluta till [!DNL Synapse] med [!DNL Flow Service] API.

### Samla in nödvändiga inloggningsuppgifter

För att [!DNL Flow Service] att ansluta till [!DNL Synapse]måste du ange värden för följande anslutningsegenskaper:
...
Om du vill skapa ett basanslutnings-ID skickar du en POST till `/connections` slutpunkt när du ger [!DNL Synapse] autentiseringsuppgifter som en del av parametrarna för begäran.
...
Genom att följa den här självstudiekursen har du skapat en [!DNL Synapse] basanslutning med [!DNL Flow Service] API. Du kan använda detta grundläggande anslutnings-ID i följande självstudier:
