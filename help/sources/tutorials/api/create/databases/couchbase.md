...
Om du vill skapa ett basanslutnings-ID skickar du en POST-begäran till `/connections`-slutpunkten och anger dina [!DNL Couchbase]-autentiseringsuppgifter som en del av parametrarna för begäran.
