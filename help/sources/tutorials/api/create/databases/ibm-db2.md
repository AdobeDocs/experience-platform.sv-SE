...
# Skapa en IBM DB2-anslutning med [!DNL Flow Service] API
...
I den här självstudiekursen används API:t för att vägleda dig genom stegen för att ansluta IBM DB2 (nedan kallat &quot;DB2&quot;) till [!DNL Flow Service] [!DNL Experience Platform].
...
I den här självstudiekursen har du skapat en IBM DB2-anslutning med API:t och fått anslutningens unika ID-värde. [!DNL Flow Service] Du kan använda det här ID:t i nästa självstudiekurs när du lär dig hur du [utforskar databaser med API:t](../../explore/database-nosql.md)för Flow Service.
