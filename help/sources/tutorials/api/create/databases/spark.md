...
title: Skapa en Apache Spark på Azure HDInsights-källanslutning med API:t för flödestjänsten
topic: overview
type: Tutorial
...
# Skapa en [!DNL Apache Spark] på [!DNL Azure] HDInsights-källanslutning med hjälp av API:t [!DNL Flow Service]
