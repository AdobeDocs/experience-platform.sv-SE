...
Genom att följa den här självstudiekursen har du skapat en [!DNL Spark] basanslutning med [!DNL Flow Service] API. Du kan använda detta grundläggande anslutnings-ID i följande självstudier:
