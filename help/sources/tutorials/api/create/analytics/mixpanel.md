...
Om du vill skapa ett grundläggande anslutnings-ID skickar du en POST till `/connections`-slutpunkten och anger dina [!DNL Mixpanel] autentiseringsuppgifter som en del av begärandetexten.
...
| `data.format` | Formatet för de [!DNL Mixpanel]-data som du vill hämta till plattformen. |
...
Det sista steget mot att överföra data från [!DNL Mixpanel] till plattformen är att skapa ett dataflöde. Nu har du förberett följande obligatoriska värden:
