...
# Skapa en FTP-anslutning med [!DNL Flow Service] API

>[!NOTE]
>
>FTP-kopplingen är i betaversion. Funktionerna och dokumentationen kan komma att ändras. Mer information om hur du använder betatecknade anslutningar finns i [Källor-översikten](../../../../home.md#terms-and-conditions) .

I den här självstudiekursen används API:t för att vägleda dig genom stegen för att ansluta [!DNL Flow Service] [!DNL Experience Platform] till en FTP-server (File Transfer Protocol).
...
I följande avsnitt finns ytterligare information som du behöver känna till för att kunna ansluta till en FTP-server med hjälp av [!DNL Flow Service] API:t.

### Samla in nödvändiga inloggningsuppgifter

För [!DNL Flow Service] att kunna ansluta till FTP måste du ange värden för följande anslutningsegenskaper:
...
Om du vill skapa en FTP-anslutning med grundläggande autentisering skickar du en POST till API:t samtidigt som du anger värden för anslutningsens [!DNL Flow Service] , `host`och `userName``password`.
...
I den här självstudiekursen har du skapat en FTP-anslutning med API:t och fått anslutningens unika ID-värde. [!DNL Flow Service] Du kan använda det här anslutnings-ID:t för att [utforska molnlagring med API:t](../../explore/cloud-storage.md) för Flow Service eller [inmatningsdata med API:t](../../cloud-storage-parquet.md)för Flow Service.
