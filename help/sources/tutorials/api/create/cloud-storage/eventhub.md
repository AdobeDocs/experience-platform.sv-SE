...
topic: overview
type: Tutorial
description: I den här självstudien används API:t för Flow Service för att vägleda dig genom stegen för att ansluta Experience Platform till ett Azure Event Hubs-konto.
...
Genom att följa den här självstudiekursen har du skapat en [!DNL Azure Event Hubs] anslutning med API:er och ett unikt ID har hämtats som en del av svarstexten. Du kan använda detta anslutnings-ID för att [samla in strömmande data med API:t](../../collect/streaming.md)för Flow Service.