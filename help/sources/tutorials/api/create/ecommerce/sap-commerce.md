...
I följande självstudiekurs får du hjälp med att skapa en [!DNL SAP Commerce] källanslutning och ett dataflöde som kan ge [[!DNL SAP] Prenumerationsfakturering](https://www.sap.com/products/financial-management/subscription-billing.html) kontakter och kunddata till Adobe Experience Platform med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
I följande avsnitt finns ytterligare information som du behöver känna till för att kunna ansluta till [!DNL SAP Commerce] med [!DNL Flow Service] API.
...
## Anslut [!DNL SAP Commerce] till plattform med [!DNL Flow Service] API

Följande beskriver de steg du måste utföra för att autentisera dina [!DNL SAP Commerce] källa, skapa en källanslutning och skapa ett dataflöde för att överföra dina konton och kontaktdata till Experience Platform.

### Skapa en basanslutning {#base-connection}

En basanslutning bevarar information mellan källan och plattformen, inklusive källans autentiseringsuppgifter, anslutningsstatus och ditt unika basanslutnings-ID. Med det grundläggande anslutnings-ID:t kan du utforska och navigera bland filer inifrån källan och identifiera de specifika objekt som du vill importera, inklusive information om deras datatyper och format.

Om du vill skapa ett basanslutnings-ID skickar du en POST till `/connections` slutpunkt när du ger [!DNL SAP Commerce] autentiseringsuppgifter som en del av begärandetexten.
...
The [!DNL SAP Commerce] har stöd för flera API:er. Beroende på vilken objekttyp du utnyttjar den begäran som ska skickas anges nedan:
...
För [!DNL SAP Commerce] Kunder-API:t har värdet för `{SOURCE_PARAMS}` skickas som `{"object_type":"customers"}`. När den kodas i base64 är den lika med `eyJvYmplY3RfdHlwZSI6ImN1c3RvbWVycyJ9` enligt nedan.
...
| `data.format` | Formatet på [!DNL SAP Commerce] data som du vill importera. |
...
I följande begäran skapas en mappning för [!DNL SAP Commerce] Kundens API-data
...
I följande begäran skapas en mappning för [!DNL SAP Commerce] API-data för kontakter
...
Det sista steget mot att hämta in data från [!DNL SAP Commerce] till Platform är att skapa ett dataflöde. Nu har du förberett följande obligatoriska värden:
