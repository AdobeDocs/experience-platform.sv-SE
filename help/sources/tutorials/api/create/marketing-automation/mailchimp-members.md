...
I följande självstudiekurs får du hjälp med att skapa en källanslutning och ett dataflöde för att överföra [!DNL Mailchimp Members]-data till Experience Platform med [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/) .
...
När du har hämtat dina autentiseringsuppgifter för [!DNL Mailchimp] kan du nu starta processen med att skapa dataflöde för att överföra [!DNL Mailchimp Members]-data till Experience Platform. Det första steget i att skapa ett dataflöde är att skapa en basanslutning.
