...
I följande tabell visas felen när det gäller intern validering i Flow Service.

| Felkod | Titel | Detaljerat meddelande |
| --- | --- | --- |
| `1100-400` | Ogiltig begäran | Det gick inte att bearbeta begäran. Fel från flödesprovider: Inte berättigad till den här åtgärden. |
| `1101-404` | Resursen hittades inte | Den begärda resursen hittades inte. Fel från flödesprovider: Resursen med angivet ID finns inte. |
...
| `1104-504` | Tidsgräns för gateway | En gatewaytimeout har inträffat. Försök igen. Kontakta kundsupport om problemet kvarstår. |
...
| `1407-400` | Ogiltig begäran | Statusen misslyckades kan inte användas med subOp `progress`. Ta bort `progress` subOp eller använd status=&#39;inProgress&#39; och försök igen. |
...
| `1414-400` | Ogiltig begäran | Anslutningens specifikation kan inte uppdateras. |
...
| `1417-400` | Ogiltig begäran | Borttagning eller uppdatering för anslutningar i tillståndet `initializing` tillåts inte med UserToken. |
...
| `1420-400` | Ogiltig begäran | Det går inte att uppdatera inaktiveringen av det aktuella läget. |
...
| `1435-400` | Ogiltig begäran | Underåtgärden &quot;reverse&quot; stöds inte. Använd någon av underåtgärdstyperna som stöds och försök igen. |
| `1436-400` | Ogiltig begäran | En PROGRESS som inte stöds togs emot för aktivering av åtgärd. |
| `1437-400` | Ogiltig begäran | Statusvärdet &#39;started&#39; som inte stöds togs emot. Uppdatera statusvärdet och försök igen. |
...
| `1455-400` | Ogiltig begäran | Ett fel uppstod vid validering av korrigeringsinstruktioner: fältet keyThatDoesNotExist saknas. |
| `1456-400` | Ogiltig begäran | Borttagning av tillstånd är inte ett giltigt värde. Tillåtna värden är [aktiverade, inaktiverade, initierar]. |
...
| `2001-401` | Rubriken saknas eller är tom | Rubriken x-gw-ims-org-id saknas eller är tom. Uppdatera rubrikvärdet och försök igen. |
...
| `2101-404` | Sandlådan hittades inte | Det gick inte att hitta sandlådan med namnet dev. Fel från API:t för sandlådehantering: Det finns ingen sandlåda med namnet dev. Kontrollera om resursen finns. |
| `2102-500` | Hämta sandlåda efter namnfel | Det gick inte att hämta en sandlåda med namnet &#39;dev&#39;. Fel från API:t för sandlådehantering: Ett fel uppstod. Försök igen. |
...
| `2104-500` | Hämta sandlåda efter identifierarfel | Ett problem uppstod när en sandlåda med ID &#39;8da3ef09-b469-404a&#39; och namnet &#39;dev&#39; skulle hämtas. Fel från API:t för sandlådehantering: Ett fel uppstod. Försök igen. |
...
| `2107-500` | Hämta standardsandlådefel | Det gick inte att hämta en standardsandlåda. Fel från API:t för sandlådehantering: Ett fel uppstod. Försök igen. |
| `2108-500` | Hämta fel för aktiva sandlådor | Det gick inte att hämta en aktiv sandlåda. Fel från API:t för sandlådehantering: Ett fel uppstod. Försök igen. |
...
| `2121-403` | Förbjuden | Behörighetshanteraren nekas för resursen Enterprise Source. Kontakta administratören för att lösa behörigheterna och försök igen. |
