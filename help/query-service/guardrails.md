...
| Användare av Concurrent Query Service | <ul><li>Som anges i produktbeskrivningen för programmet.</li><li>+5 (med varje ytterligare Ad hoc-frågeanvändartillägg inköpt)</li></ul> | Systemstyrt skyddsräcke | Detta definierar hur många användare som kan skapa sessioner samtidigt för en viss organisation. Om samtidighetsgränsen överskrids får användaren en `Session Limit Reached` fel. |
