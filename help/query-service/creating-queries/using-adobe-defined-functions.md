...
topic: queries
type: Tutorial
description: Det här dokumentet innehåller Adobe-definierade funktioner (ADF) som har stöd för tre viktiga analysaktiviteter som sessioner, attribuering och kundvägar.
