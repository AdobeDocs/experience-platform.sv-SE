...
![Ett entitetsrelationsdiagram (ERD) för användarmodellen för målgruppsinsikter.](../../images/data-distiller/customizable-insights/audience-insight-user-model.png)
...
![Ett ERD-diagram som länkar datamodellen för Real-Time CDP-insikter och databasmodellen för Query-accelererade funktioner.](../../images/data-distiller/customizable-insights/updatingAudienceInsightUserModel.png)
...
![Ett matchningsantal per mål och målgruppswidget som har skapats från den nya datamodellen för rapportinsikter.](../../images/data-distiller/customizable-insights/user-defined-dashboard-widget.png)
