...
På arbetsytan Frågor i plattformsgränssnittet väljer du **[!UICONTROL Browse]** om du vill visa en lista med tillgängliga sparade frågor.

![Frågearbetsytan med fliken Bläddra markerad.](../images/ui/query-templates/query-templates.png)
