...
Data Distiller SKU krävs för att använda det frågeaccelererade arkivet. Se dokumentationen för [paketering](../packaging.md), [skyddsutkast](../guardrails.md#query-accelerated-store) och [licensiering](../data-distiller/license-usage.md) som gäller Data Distiller SKU. Om du inte har Data Distiller SKU kontaktar du Adobe kundtjänstrepresentant för mer information.
...
Gör en POST-begäran till `/accelerated-queries`-slutpunkten om du vill köra en accelererad fråga. Frågan finns antingen direkt i nyttolasten eller refereras till med ett mall-ID.
...
| `templateId` | Den unika identifieraren för en fråga som skapats och sparats som en mall när en POST-begäran görs till slutpunkten `/templates`. |
