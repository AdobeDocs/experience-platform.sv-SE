...
| Adobe Campaign Classic | ✓ | ✓ | Den registrerades lagrade data tas bort från systemet. | <ul><li>[Integritetshantering](https://experienceleague.adobe.com/en/docs/campaign-classic/using/getting-started/privacy/privacy-management)</li></ul> |
...
| Adobe kundattribut (CRS) | ✓ | N/A | Den registrerades attribut tas bort från systemet. | <ul><li>[Åtkomst/borttagningsdokumentation för GDPR](https://experienceleague.adobe.com/en/docs/core-services/interface/services/customer-attributes/gdpr)</li><li>[Åtkomst/borttagningsdokumentation för CCPA](https://experienceleague.adobe.com/en/docs/core-services/interface/services/customer-attributes/ccpa)</li><li>Kundattribut har inte möjlighet att överföra data, och därför kan du inte avanmäla dig från försäljning.</li></ul> |
...
| ------- | ----------- |
| [Adobe Experience Manager](https://experienceleague.adobe.com/en/docs/experience-manager-64/managing/data-protection/data-protection-and-privacy) | En översikt över hur en kundsekretessadministratör eller AEM-administratör kan hantera GDPR-begäranden. |
