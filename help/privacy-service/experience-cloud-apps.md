...
| --- | :---: | :---: | --- | --- |
| Adobe Advertising | ✓ | ✓ | Den registrerades cookie-ID eller enhets-ID tas bort från systemet tillsammans med alla kostnads-, klick- och intäktsdata som är kopplade till cookien. | <ul><li>[Åtkomst/borttagningsdokumentation för GDPR](https://experienceleague.adobe.com/sv/docs/advertising/privacy/gdpr)</li><li>[Åtkomst/borttagningsdokumentation för CCPA](https://experienceleague.adobe.com/sv/docs/advertising/privacy/ccpa/ccpa-access-delete)</li><li>[Dokumentation om avanmälan för CCPA](https://experienceleague.adobe.com/sv/docs/advertising/privacy/ccpa/ccpa-opt-out-of-sale)</li></ul> |
| Adobe Analytics | ✓ | ✓ | Adobe Analytics tillhandahåller verktyg för märkning av data utifrån dess känslighet och avtalsbegränsningar. Etiketter är ett viktigt steg för:<ol><li>Identifiera registrerade personer.</li><li>Avgör vilka data som ska returneras som en del av en åtkomstbegäran.</li><li>Identifierar datafält som måste tas bort som en del av en raderingsbegäran.</li></ol> | <ul><li>[Sekretessarbetsflöde](https://experienceleague.adobe.com/sv/docs/analytics/technotes/privacy/gdpr)</li><li>[Analysetikett](https://experienceleague.adobe.com/sv/docs/analytics/admin/admin-tools/privacy-labeling/labels)</li><li>[Analysalternativ](https://experienceleague.adobe.com/sv/docs/analytics/components/dimensions/cm-opt-out)</li></ul> |
| Adobe Audience Manager | ✓ | ✓ | Alla egenskaper och segment som är kopplade till Audience Manager-identifieraren som ingår i begäran tas bort. Dessutom är respektive identifierare för den enskilda personen avanmäld från ytterligare datainsamling och respektive ID-mappningar tas bort. | <ul><li>[Åtkomst](https://experienceleague.adobe.com/sv/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests#access-data) / [ta bort](https://experienceleague.adobe.com/sv/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests#delete-data) dokumentation</li><li>[Avanmäl dokumentation](https://experienceleague.adobe.com/sv/docs/audience-manager/user-guide/features/declared-ids#opt-out-calls)</li><li>[Avanmäl förfrågningar](https://experienceleague.adobe.com/sv/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests#opt-out-requests)</li></ul> |
| Adobe Campaign Classic | ✓ | ✓ | Den registrerades lagrade data tas bort från systemet. | <ul><li>[Integritetshantering](https://experienceleague.adobe.com/sv/docs/campaign-classic/using/getting-started/privacy/privacy-management)</li></ul> |
...
| Adobe kundattribut (CRS) | ✓ | N/A | Den registrerades attribut tas bort från systemet. | <ul><li>[Åtkomst/borttagningsdokumentation för GDPR](https://experienceleague.adobe.com/sv/docs/core-services/interface/services/customer-attributes/gdpr)</li><li>[Åtkomst/borttagningsdokumentation för CCPA](https://experienceleague.adobe.com/sv/docs/core-services/interface/services/customer-attributes/ccpa)</li><li>Kundattribut har inte möjlighet att överföra data, och därför kan du inte avanmäla dig från försäljning.</li></ul> |
...
| ------- | ----------- |
| [Adobe Experience Manager](https://experienceleague.adobe.com/sv/docs/experience-manager-64/managing/data-protection/data-protection-and-privacy) | En översikt över hur en kundsekretessadministratör eller AEM-administratör kan hantera GDPR-begäranden. |
