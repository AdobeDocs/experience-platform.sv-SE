...
Följ självstudiekursen om [att prenumerera på [!DNL I/O Event] meddelanden](../observability/notifications/subscribe.md) för mer information om hur du gör detta. Se till att du väljer **[!UICONTROL Privacy Service Events]** som händelseleverantör för att få tillgång till de händelser som listas ovan.

## Ta emot [!DNL Privacy Service Event] meddelanden

När du har registrerat webkrok- och sekretessjobben kan du börja få händelsemeddelanden. Dessa händelser kan visas med webbhollen eller genom att du väljer **[!UICONTROL Debug Tracing]** fliken i projektregistreringsöversikten i Adobe Developer Console.

![](images/privacy-events/debug-tracing.png)

Följande JSON är ett exempel på en [!DNL Privacy Service Event] meddelandenyttolast som skickas till din webkrok när något av de program som är kopplade till ett sekretessjobb har slutfört sitt arbete:
