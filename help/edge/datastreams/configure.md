...
![Alternativ för att redigera eller ta bort ett befintligt datastam](../assets/datastreams/configure/edit-datastream.png)

## Skapa ett nytt datastream {#create}

Om du vill skapa ett datastream börjar du med att välja **[!UICONTROL New Datastream]**.

![Välj nytt datastream](../assets/datastreams/configure/new-datastream-button.png)
...
![Grundkonfiguration för ett datastream](../assets/datastreams/configure/configure.png)
...
![Informationssida för ett datastream som skapats](../assets/datastreams/configure/view-details.png)
...
![Välj Lägg till tjänst för att fortsätta](../assets/datastreams/configure/add-service.png)
...
![Välj en tjänst i listan](../assets/datastreams/configure/service-selection.png)
...
![Tjänster som lagts till i ett datastream](../assets/datastreams/configure/services-added.png)
...
![Inställningsblock för hantering av målgruppshantering i Adobe](../assets/datastreams/configure/audience-manager-config.png)
...
>
>![Markerad sandlåda](../assets/datastreams/configure/platform-sandbox.png)
>
...
![Adobe Experience Platform inställningsblock](../assets/datastreams/configure/platform-config.png)
...
![Adobe Target inställningsblock](../assets/datastreams/configure/target-config.png)
...
![Avsnittet Händelsevidarebefordran i konfigurationsgränssnittet](../assets/datastreams/configure/event-forwarding-config.png)
...
![Bilden visar [!UICONTROL Copy] det alternativ som väljs i datastreams listvy](../assets/datastreams/configure/copy-datastream-list.png)

Du kan också välja **[!UICONTROL Copy Datastream]** från detaljvyn för en viss datastream.

![Bilden visar [!UICONTROL Copy] alternativ som väljs från datastream-informationsvyn](../assets/datastreams/configure/copy-datastream-details.png)
...
![Bild av bekräftelsedialogrutan för kopiering av ett datastream](../assets/datastreams/configure/copy-datastream-confirm.png)
