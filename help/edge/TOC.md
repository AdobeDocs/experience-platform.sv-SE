...
* Lösningsspecifika överväganden {#solutions}
   ...
   * IAB Transparency and Consent Framework 2.0 {#iab-tcf}
      * [Översikt](solution-specific/iab-tcf/overview.md)
      * [Integrera med Launch](solution-specific/iab-tcf/with-launch.md)
      * [Integrera utan Launch](solution-specific/iab-tcf/without-launch.md)
   * Målgrupp {#target}
...
* [Vanliga frågor](getting-started/web-sdk-faq.md)