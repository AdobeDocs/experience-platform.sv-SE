...
När cookie-filen som innehåller ECID har angetts kommer varje efterföljande begäran som genereras av Web SDK att innehålla ett kodat ECID i `kndctr_{YOUR-ORG-ID}_AdobeOrg_identity` cookie.
