...
I det här exemplet är `result.propositions`, om det finns, en matris som innehåller personaliseringsförslag relaterade till händelsen. Mer information om innehållet i `result.propositions` finns i [Återge innehåll för personalisering](../rendering-personalization-content.md).
