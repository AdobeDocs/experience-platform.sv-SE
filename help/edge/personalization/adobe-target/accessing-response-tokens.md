...
I det här exemplet `result.propositions`, om det finns, är en matris som innehåller personaliseringsförslag för händelsen. Se [Återger innehåll för personalisering](../rendering-personalization-content.md) för mer information om innehållet i `result.propositions`.
