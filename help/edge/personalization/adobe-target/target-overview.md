...
mboxTrace och mboxDebug har tagits bort. Använd [[!DNL Web SDK] felsökning](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/debugging.html).
