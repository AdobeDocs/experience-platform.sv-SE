...
| Etikett | Definition |
|---|---|
| **C1** | Data kan bara exporteras från Adobe Experience Cloud i en aggregerad form utan att innehålla identifierare för enskilda enheter eller enheter. [Mer information...](#c1) |
