...
>[!NOTE]
>
>Om det finns etiketter för den aktuella datauppsättningen kan nya etiketter bara läggas till via en PUT-begäran, vilket kräver en `If-Match` header. När etiketterna har lagts till i en datauppsättning är den senaste `etag` måste uppdateras eller tas bort vid ett senare tillfälle.
