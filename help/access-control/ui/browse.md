...
Den här användarhandboken fokuserar på hur du använder [!DNL Admin Console] för att tilldela behörigheter för plattformen. Mer allmän information om hur du navigerar i [!DNL Admin Console] finns i [användarhandboken för Admin Console](https://helpx.adobe.com/enterprise/using/admin-console.html).
