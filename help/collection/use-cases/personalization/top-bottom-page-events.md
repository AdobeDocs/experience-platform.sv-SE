...
För att optimera inläsningstiderna och leverera personalisering så snabbt som möjligt stöder Web SDK konfigurationen av sidans övre och nedre del.
...
Genom att använda de övre och nedre delarna av sidhändelser i Web SDK kan marknadsföringsteamet konfigurera sin personaliseringsleverans på det optimala sättet:

* Web SDK skickar en begäran om personalisering som läses in så snart sidan börjar läsas in. Det här är en toppnod i en sidhändelse.
...
|---|---|---|
| `type` | Obligatoriskt | Ställ in den här parametern på `decisioning.propositionFetch`. Den här speciella händelsetypen talar om för Adobe Analytics att den här händelsen ska släppas. När du använder Customer Journey Analytics kan du också konfigurera ett filter för att släppa dessa händelser. |
