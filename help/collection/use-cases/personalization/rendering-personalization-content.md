...
Dessutom utnyttjar Web SDK personaliseringsfunktioner på samma sida och nästa sida via Adobe Experience Platform personaliseringsmål, till exempel [Adobe Target](/help/destinations/catalog/personalization/adobe-target-connection.md) och [anpassade personaliseringsanslutningar](/help/destinations/catalog/personalization/custom-personalization.md). Mer information om hur du konfigurerar Experience Platform för anpassning av samma sida och nästa sida finns i den [dedikerade guiden](/help/destinations/ui/activate-edge-personalization-destinations.md).
