...
När felsökning är aktiverat skickar Web SDK ut meddelanden till webbläsarkonsolen som kan vara till hjälp vid felsökning av implementeringen. Det gör det också möjligt att se [`_satellite.logger`](../tags/logger.md) meddelanden om du använder taggar som implementeringsmetod. Felsökning är värdefullt när du vill förstå hur SDK fungerar enligt de regler och dataelement som du har fastställt.
...
Mer information finns i [`debugEnabled`](../js/commands/configure/debugenabled.md).
...
Mer information finns i kommandot [`setDebug`](../js/commands/setdebug.md).
...
## Använda Adobe Experience Platform Debugger
...
![Aktivera felsökning](../js/assets/enable-debugging.png)

Mer information finns i [Adobe Experience Platform Debugger - översikt](/help/debugger/home.md).
