...
För datainsamling i realtid samlas [Experience Events](/help/xdm/classes/experienceevent.md) in via Edge Network från källor på klientsidan, till exempel Web SDK eller [Mobile SDK](https://developer.adobe.com/client-sdks/home/), och levereras till Experience Platform bearbetnings- och lagringslager. Dessa lager utgör lösningar som Experience Platform, [Real-Time CDP](/help/rtcdp/home.md), [Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-overview.html?lang=sv-SE) och [Adobe Journey Optimizer](https://experienceleague.adobe.com/docs/journey-optimizer/using/ajo-home.html?lang=sv-SE).
...
* Real-Time CDP Profile Store släpper händelser om det redan finns en händelse med samma `_id` i [!DNL Profile store]. Mer information finns i dokumentationen om [XDM ExperienceEvent-klassen](/help/xdm/classes/experienceevent.md).
