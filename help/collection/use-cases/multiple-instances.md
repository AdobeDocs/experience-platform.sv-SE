...
Detta resulterar i att skriptet skapar två instanser av SDK. Den globala funktionen för interaktion med den första instansen heter `titanium` och den globala funktionen för interaktion med den andra instansen heter `copper`.
