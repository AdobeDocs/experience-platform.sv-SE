...
Se Experience Cloud ID-tjänsten [Metoder](https://experienceleague.adobe.com/en/docs/id-service/using/id-service-api/methods/get-set) i dokumentationen för Experience Cloud Visitor ID-tjänsten för att se vilka fält och metoder som är tillgängliga för dig.
