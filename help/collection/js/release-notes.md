...
- Förbättrad felhantering för [identitetshantering](../use-cases/identity/id-overview.md) för att kunna bearbeta löftesavvisanden korrekt när identitetssökningen misslyckas.
...
- Stöd har lagts till för att begära [CORE ID](/help/collection/use-cases/identity/id-overview.md) i kommandot [getIdentity](commands/getidentity.md).
