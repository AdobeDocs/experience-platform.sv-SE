...
* **Manuellt spårade mediesessioner** ger dig större kontroll över sändningen av sessionsping-händelser till [Adobe Analytics för direktuppspelningsmedia](https://experienceleague.adobe.com/sv/docs/media-analytics/using/media-overview). Dessutom kan du lagra `sessionID` för mediesessioner.
