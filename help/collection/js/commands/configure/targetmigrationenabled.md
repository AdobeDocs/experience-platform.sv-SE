...
När du använder den här egenskapen måste du även aktivera [`overrideMboxEdgeServer`](https://experienceleague.adobe.com/sv/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/targetglobalsettings#overridemboxedgeserver) i `targetGlobalSettings()` i din Adobe Target-implementering.
