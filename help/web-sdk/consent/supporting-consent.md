...
## Kommunicera medgivanden via Adobe Experience Platform-standarden
...
Om användaren väljer att gå in kör du `setConsent` med inställningen för att samla in inställd på `y` enligt följande:
...
Tidsfältet ska ange när användaren senast uppdaterade sina medgivandeinställningar. Om användaren väljer att avanmäla sig kör du `setConsent` med inställningen för att samla in inställd på `n` enligt följande:
...
Om användaren väljer att gå in kör du `setConsent` med kommandot `general` alternativ inställt på `in` enligt följande:
...
Om användaren väljer att avanmäla sig kör du `setConsent` med kommandot `general` alternativ inställt på `out` enligt följande:
