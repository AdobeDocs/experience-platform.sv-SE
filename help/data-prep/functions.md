...
| upsert_array_replace | Den här funktionen används för att ersätta element i en array. Funktionen är **endast** som kan användas under uppdateringar. Om den används i infogningskontexten returneras indata i befintligt skick. | <ul><li>ARRAY: **Obligatoriskt** Arrayen som ska ersätta arrayen i profilen.</li><li>INDEX: **Valfritt** Positionen som ersättningen ska ske från.</li></li> | upsert_array_replace(ARRAY, INDEX) | `upsert_array_replace([123, 456], 1)` | [123, 456] |
