...
| dela | Splits an input string on a separator. ****`\``\` **** | <ul><li>****</li><li>****</li></ul> | split(INPUT, SEPARATOR) | split(&quot;Hello world&quot;, &quot; &quot;) | `["Hello", "world"]` |
...
| equals | Compares two strings to confirm if they are equal. This function is case sensitive. | <ul><li>****</li><li>****</li></ul> | STRING1.&#x200B;equals(&#x200B;STRING2) | &quot;string1&quot;.&#x200B;equals&#x200B;(&quot;STRING1&quot;) | falskt |
| equalsIgnoreCase | Compares two strings to confirm if they are equal. **** | <ul><li>****</li><li>****</li></ul> | STRING1.&#x200B;equalsIgnoreCase&#x200B;(STRING2) | &quot;string1&quot;.&#x200B;equalsIgnoreCase&#x200B;(&quot;STRING1) | sant |
...
| matches_regex | Checks to see if the string matches against the inputted regular expression. | <ul><li>****</li><li>****</li></ul> | matches_regex(STRING, REGEX) | [][][] | sant |
...
| tidsstämpel | Retrieves the current Unix time. |  | tidsstämpel() | tidsstämpel() | 1571850624571 |
...
| is_empty | Checks whether or not an object is empty. | <ul><li>****</li></ul> | is_empty(INPUT) | `is_empty([1, 2, 3])` | falskt |
...
| contains_key | Checks if the object exists within the source data. ****`is_set()` | <ul><li>****</li></ul> | contains_key(INPUT) | contains_key(&quot;evars.evar.field1&quot;) | sant |
