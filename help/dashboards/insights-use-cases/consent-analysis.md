...
>[!NOTE]
>
>Det finns en mjuk gräns för hur många målgrupper du bör skapa. Mer information finns i [dokumentation om segmenteringsskyddsutkast](../../profile/guardrails.md#segmentation-guardrails).
...
Bilden nedan visar hur den färdiga widgeten visas och andra anpassade insikter. Mer information om vilka typer av widgetar som kan skapas finns i [dokumentation om datamodell](../data-models/cdp-insights-data-model-b2c.md).
