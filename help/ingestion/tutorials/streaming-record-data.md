...
Om du vill skapa en datauppsättning måste du först skapa ett nytt schema som implementerar klassen XDM Individual Profile. Mer information om hur du skapar scheman finns i utvecklarhandboken [för](../../xdm/api/getting-started.md)schemaregistrets API.
