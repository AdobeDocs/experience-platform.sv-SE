---
title: Garantier för identitetstjänsten (med borttagningslogik)
description: Läs mer om skyddsutkast för identitetstjänsten.
hide: true
hidefromtoc: true
...
# Guardrails för [!DNL Identity Service] data (med borttagningslogik)
