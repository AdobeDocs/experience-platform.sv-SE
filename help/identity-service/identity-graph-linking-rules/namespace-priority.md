...
* Du kan samla in onlinebeteende med hjälp av namnutrymmet Inloggnings-ID. Detta inloggnings-ID kan ha en :1-relation med CRMID, som sedan lagrar attribut från ett CRM-system och kan betraktas som det viktigaste namnområdet. I det här fallet avgör du att CRMID-namnutrymmet är en mer korrekt representation av en person, medan namnutrymmet för inloggnings-ID är det näst viktigaste.
...
![Ett diagram över diagramlager](../images/namespace-priority/graph-layers.png "Ett diagram över diagramlager"){zoomable="yes"}
...
![Ett diagram över segmentmedlemskapslagring.](../images/namespace-priority/segment-membership-storage.png "Ett diagram över segmentmedlemskapslagring."){zoomable="yes"}
...
* Mer information finns i [Adobe Experience Platform- och programarkitekturdiagrammen](https://experienceleague.adobe.com/sv/docs/blueprints-learn/architecture/architecture-overview/platform-applications#detailed-architecture-diagram) och [Edge Network- och navjämförelsesidorna](/help/landing/edge-and-hub-comparison.md).
...
* Läs dokumentationen om [dataelementtyperna](/help/tags/extensions/client/web-sdk/data-element-types.md) och [Identiteten i datainsamlingen](/help/collection/identity/overview.md) om du vill ha mer information om hur du konfigurerar den primära identiteten på Web SDK.
