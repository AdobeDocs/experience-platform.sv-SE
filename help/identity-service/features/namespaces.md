...
Om du anger namnutrymmet för en identitet beror på vilken metod du använder för att ange identitetsdata. Mer information om att tillhandahålla data om identitetsuppgifter finns i [[!DNL Identity Service] implementeringsguide](../implementation.md).

## Nästa steg

Nu när du förstår de viktigaste begreppen för identitetsnamnutrymmen kan du börja lära dig hur du arbetar med identitetsdiagrammet med [visningsprogram för identitetsdiagram](../features/identity-graph-viewer.md).
