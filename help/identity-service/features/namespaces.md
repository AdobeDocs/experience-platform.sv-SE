...
I Experience Platform finns flera identitetsnamnutrymmen som är tillgängliga för alla organisationer. Dessa kallas standardnamnutrymmen och visas med API:t [!DNL Identity Service] eller med Experience Platform-gränssnittet.
...
| Adobe Analytics (äldre ID) | Ett namnutrymme som representerar Adobe Analytics. Mer information finns i följande dokument om [Adobe Analytics-namnutrymmen](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/gdpr-namespaces.html?lang=sv-SE#namespaces). |
...
| TNTID | Ett namnutrymme som representerar Adobe Target. Mer information finns i följande dokument på [Target](https://experienceleague.adobe.com/docs/target/using/target-home.html?lang=sv-SE). |
