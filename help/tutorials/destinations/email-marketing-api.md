...
![Översiktssteg för målsteg 1](../images/destinations/flow-api-destinations-step1.png)
...
![Översikt över destinationssteg 3](../images/destinations/flow-api-destinations-step3.png)
...
![Översikt över destinationssteg steg 5](../images/destinations/flow-api-destinations-step5.png)
...
* `{SEGMENT_ID}`: Ange det segment-ID som du vill exportera till det här målet. Om du vill hämta segment-ID:n för de segment som du vill aktivera går du till https://www.adobe.io/apis/experienceplatform/home/api-reference.html#/ och letar efter `GET /segment/jobs` åtgärden.
...
![Översiktssteg för målsteg 6](../images/destinations/flow-api-destinations-step6.png)
