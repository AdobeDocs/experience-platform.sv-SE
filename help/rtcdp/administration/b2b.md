...
I följande dokument finns detaljerade anvisningar om hur du använder [Adobe Admin Console](https://adminconsole.adobe.com) för att aktivera B2B-gränssnittsåtkomst för en produktprofil:
