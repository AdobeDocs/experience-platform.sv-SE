...
Använd [!DNL Real-Time Customer Data Platform] för att hämta nya datakällor till plattformen. Real-Time CDP innehåller en katalog med datakällor som snabbt och enkelt kan läggas till i profilen.
