...
description: Tillägget Flashtalk OneTag är ett reklammål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
# Flashtalk OneTag-tillägg {#flashtalking-extension}

## Översikt {#overview}

Med tillägget Flashtalk OneTag för Experience Platform Launch är det enkelt att attribuera webbplatsåtgärder för att visa, video och mobilannonsering. Distribuera Flashtalk OneTag till dina webbegenskaper med Launch.

Flashtalk OneTag är ett reklamtillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
Så här installerar du tillägget Flashtalk OneTag:
