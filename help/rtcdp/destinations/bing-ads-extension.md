...
Så här installerar du UET-tillägget (Bing Ads Universal Event Tracking):
...
Information om alternativ för tilläggskonfiguration och installationsstöd finns på sidan UET ( [Bing Ads Universal Event Tracking) på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
