...
description: Tillägget Yext Conversion Tracking är ett analysmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget Yext Conversion Tracking är ett analysmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
Med tillägget Yext Conversion Tracking kan du mäta konverteringar som kan tillskrivas din användning av Yext-produkter.

Yext Conversion Tracking är ett analystillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
Så här installerar du tillägget för ÅXT Conversion Tracking:
...
Information om alternativ för tilläggskonfiguration och installationsstöd finns på sidan [Textkonverteringsspårning på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
