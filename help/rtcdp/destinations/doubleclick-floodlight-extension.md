...
description: Tillägget DoubleClick Floodlight (Beta) är ett reklammål i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget DoubleClick Floodlight (Beta) är ett reklammål i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
[!DNL DoubleClick Floodlight] (Beta) är ett reklamtillägg i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionen finns i supportdokumentationen för [!DNL Google] DoubleClick Floodlight [](https://support.google.com/dcm/answer/2823388?hl=en).
