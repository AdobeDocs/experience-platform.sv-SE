...
description: PebblePost-tillägget är ett e-postmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget PebblePost är ett e-postmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
# PebblePost-tillägg {#pebblepost-extension}

## Översikt {#overview}

Med PebblePosts lösning för programmatisk direktreklam kan digitala marknadsförare koppla samman online-intressen och avsikter med offlinematerial som kan konverteras. Marknadsförarna kan utnyttja de anpassade datasegment de har skapat i Adobe för att nu rikta sig till kunderna med ett relevant, längre intryck av hemmedia. Analysera prestanda i realtid baserat på responssökvägsaktivitet och konverteringar på plats.

PebblePost är ett e-posttillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
...
![PebblePost-tillägg](assets/pebblepost-extension.png)
...
Så här installerar du PebblePost-tillägget:
