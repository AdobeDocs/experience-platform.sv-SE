---
title: Platform-mål för datahantering (DMP)
seo-title: Platform-mål för datahantering (DMP)
...
För närvarande stöder Adobe Real-time Customer Data Platform de Data Management Platform-mål (DMP) som listas nedan. Information om hur du ansluter till dessa mål finns i de enskilda länkarna:
