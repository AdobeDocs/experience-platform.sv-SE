...
# Pixeltillägg för Facebook {#facebook-pixel-extension}

## Översikt {#overview}

Pixeln på Facebook är ett analysverktyg som gör att ni kan mäta hur effektiv er annonsering är genom att förstå vilka åtgärder användarna vidtar på er webbplats.
...
Så här installerar du Facebook Pixel-tillägget:
