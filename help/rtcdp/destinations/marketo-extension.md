...
description: Tillägget Marketo är ett e-postmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget Marketo är ett e-postmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
# Marketo-tillägg {#marketo-extension}

## Översikt {#overview}

Marketos kraftfulla program för automatiserad marknadsföring hjälper marknadsförare att bemästra konsten och vetenskapen inom digital marknadsföring för att engagera kunder och potentiella kunder.

Marketo är ett e-posttillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på [tilläggssidan på Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101071.marketo-for-adobe-launch.html).
...
Så här installerar du tillägget Marketo:
