...
description: Medietillägget är en röst för kundens destination i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Medietillägget är en röst för kundens destination i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
# Media Extension {#medallia-extension}

## Översikt {#overview}

Driftsätt mediefiler snabbt och smidigt på webben. Tillägget gör det även möjligt att identifiera enkäthändelser, samla in kundfeedback i realtid via dataelement, använda det i regler för att personalisera kundupplevelsen och dela data med Adobe Analytics.

Medallia är en röst för kundens utökning i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
...
![Media Extension](assets/medallia-extension.png)
...
Så här installerar du medietillägget:
