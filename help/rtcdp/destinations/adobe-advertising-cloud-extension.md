...
description: Adobe Advertising Cloud-tillägget är en annonsdestination i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
Det här är Advertising Cloud-tillägget för implementering av Advertising Cloud-konverterings- och segmenttaggar för både DSP och Search (DCO stöds inte för närvarande).

Adobe Advertising Cloud är ett annonstillägg i Adobes kunddataplattform i realtid.
