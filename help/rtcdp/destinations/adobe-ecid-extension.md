...
seo-title: Tjänsttillägg för Experience Cloud ID
...
# Tjänsttillägg för Experience Cloud ID {#adobe-ecid-extension}

## Översikt {#overview}

Det här tillägget implementerar Experience Cloud ID-tjänsten, som identifierar besökare i alla Experience Cloud-lösningar.
...
Så här installerar du tillägget för Experience Cloud ID-tjänsten:
...
Information om alternativ för tilläggskonfiguration och installationsstöd finns på [Experience Cloud ID-tjänstens tilläggssida](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) i dokumentationen för Experience Launch.
