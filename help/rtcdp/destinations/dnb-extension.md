...
description: Tillägget D&B Visitor Intelligence är en personaliseringsdestination i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget D&B Visitor Intelligence är en personaliseringsdestination i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
[!DNL D&B Visitor Intelligence] är ett personaliseringstillägg i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på [D&amp;B-webbplatsen](https://www.dnb.com/).
