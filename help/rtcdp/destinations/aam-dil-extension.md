...
description: Audience Manager DIL-tillägget är ett mål för datahanteringsplattformen (DMP) i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Audience Manager DIL-tillägget är ett mål för datahanteringsplattformen (DMP) i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
Det här är Adobe Audience Manager-tillägget för dataintegreringsbibliotek (implementering på klientsidan). Obs! Det här tillägget är inte avsett att användas för vidarebefordran på serversidan av Adobe Analytics-data. För SWF använder du Adobe Analytics-tillägget. Viktigt: Från och med version 8.0 är DIL beroende av Experience Cloud ID-tjänsten, version 3.3 eller senare. Implementera både Experience Cloud ID-tjänsten och DIL för att få tillgång till fullständiga funktioner för dataintegrering med Audience Manager.

Audience Manager DIL är ett DMP-tillägg (Data Management Platform) i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktioner finns på [Audience Manager-tilläggssidan](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) i dokumentationen för Experience Platform Launch.
...
Så här installerar du Audience Manager DIL-tillägget:
...
Information om alternativen för tilläggskonfigurering finns på [tilläggssidan](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) för Audience Manager i dokumentationen för Experience Launch.
