...
description: Tillägget QuestionPro Intercept Surveys är en undersökningsdestination i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget QuestionPro Intercept Surveys är en undersökningsdestination i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
QuestionPro Intercept Survey är en plattform för att distribuera enkäter och samla in attityddata vid transaktionstillfället eller när användare går in på/ut från webbplatsen.

QuestionPro Intercept Surveys är ett undersökningstillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
Så här installerar du tillägget QuestionPro Intercept Surveys:
