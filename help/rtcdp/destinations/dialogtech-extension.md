...
# DialogTech-tillägg {#dialogtech-extension}

## Översikt {#overview}

Inkludera JavaScript-fragmentet DialogTech SourceTrak i Adobe Launch

DialogTech är ett analystillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktioner finns på [Dialogtech-webbplatsen](https://www.dialogtech.com/).
...
Så här installerar du tillägget DialogTech:
