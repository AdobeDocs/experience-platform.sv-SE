...
description: Tillägget DialogTech är ett analysmål i kunddataplattformen i Adobe i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget DialogTech är ett analysmål i kunddataplattformen i Adobe i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
[!DNL DialogTech] är ett analystillägg i Adobe Customer Data Platform i realtid. Mer information om tilläggsfunktioner finns på [Dialogtech-webbplatsen](https://www.dialogtech.com/).
