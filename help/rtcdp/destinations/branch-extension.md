...
description: Branch-tillägget är ett reklammål i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Branch-tillägget är ett reklammål i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
Filialen är ett reklamtillägg i Adobe Real-time Customer Data Platform. Mer information om tilläggsfunktionerna finns på sidan [](https://branch.io/features/) Funktioner på webbplatsen för grenen.
...
Så här installerar du [!DNL Branch] tillägget:
