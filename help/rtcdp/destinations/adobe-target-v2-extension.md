...
Adobe Target v2 är ett personaliseringstillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
Så här installerar du Adobe Target v2-tillägget:
...
Mer information om alternativen för tilläggskonfiguration finns på tilläggssidan [för](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/targetv2-extension/adobe-target-extension-v2.html) Adobe Target v2 i dokumentationen för Experience Launch.
