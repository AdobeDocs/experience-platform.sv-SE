...
description: Gainsight-tillägget är ett personaliseringsmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Gainsight-tillägget är ett personaliseringsmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
# Gainsight-tillägg {#gainsight-extension}

## Översikt {#overview}

Gainsight ger produktägare verktyg för att få en djupgående förståelse för användarbeteenden, få till stånd produktimplementering och samla in feedback från användarna.

Gainsight är ett personaliseringstillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
![Gainsight-tillägg](assets/gainsight-extension.png)
...
Så här installerar du Gainsight-tillägget:
