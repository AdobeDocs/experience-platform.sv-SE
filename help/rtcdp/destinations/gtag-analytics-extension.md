...
description: Tillägget Google Global Site Tag är ett analysmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
seo-description: Tillägget Google Global Site Tag är ett analysmål i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på Adobe Exchange.
...
Skicka data till Google Analytics, Google Ads och Google Marketing Platform via Googles Global Site Tag eller gtag.js. Flera konton per produkt kan konfigureras.

Google Global Site Tag är ett analystillägg i Adobes kunddataplattform i realtid. Mer information om tilläggsfunktionerna finns på tilläggssidan på [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
![Tillägget Google Global Site Tag](/help/rtcdp/destinations/assets/gtag-analytics-extension.png)
...
Så här installerar du tillägget Google Global Site Tag:
...
Mer information om alternativen för tilläggskonfigurationen finns på tilläggets [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) -sida.
