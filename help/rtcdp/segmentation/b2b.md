...
## Ändring av kopplingsprincip

Som en del av uppgraderingarna till Real-Time CDP B2B edition-arkitekturen stöder nu målgrupper med flera enheter med B2B-attribut endast en enda sammanslagningspolicy (standardsammanslagningspolicy) istället för flera sammanslagningsprinciper. Dessutom kan de förändringar i vilka profiler kan kvalificera sig för målgrupper påverka arbetsflöden längre fram i kedjan, som aktivering, färghantering och kampanjanpassning. Du rekommenderas att göra följande för att vara säker på att dina data fungerar som förväntat:

- Granska och testa alla målgrupper som förlitar sig på icke-standardlogik för sammanslagning för att förstå de potentiella effekterna av den här uppdateringen.
- Utvärdera kvalificeringskriterier för målgrupper på nytt för att förstå om ändringarna i sammanslagningslogiken kan påverka kvalifikationer.
- Övervaka aktiveringsresultaten för att upptäcka eventuella förändringar i målgruppsresultaten som orsakas av ändringen i sammanfogningspolicyn.
...
1. Skapa scheman som använder B2B-klasserna. B2B edition-klasserna omfattar konto, Campaign, Opportunity, Marketing List med flera. Mer information om [hur du ställer in scheman för användning med B2B-klasser](../schemas/b2b.md) finns i schemadokumentationen.
2. Skapa relationer mellan era B2B-scheman i Experience Data Model (XDM). Målgrupper som bygger på B2B edition-attribut kräver relationer mellan klasserna för att fullt ut kunna använda den utökade funktionen för B2B-segmentering. Mer information finns i dokumentationen om [hur du definierar en relation mellan två B2B-scheman](../../xdm/tutorials/relationship-b2b.md).
...
![Klassen B2B ERD](../assets/segmentation/b2b/b2b-classes.png)
...
![källnyckelsexempel med personrelationen i schemaarbetsytan](../assets/segmentation/b2b/source-key-schema-relationship-example.png)

Relationen återspeglas i segmentbyggaren genom att `Key`-mappar används, vilket visas i bilden nedan.

![källnyckelsexempel med segmentverktyget i segmenteringsarbetsytan](../assets/segmentation/b2b/source-key-segmentation-example.png)

Mer information om tillgängliga B2B-klasser finns i [scheman i Real-Time Customer Data Platform B2B edition-dokumentationen](../schemas/b2b.md).
...
Följande användningsexempel kan segmenteras med B2B edition. Varje exempel innehåller en beskrivning av vad publiken gör och en beskrivning av de klasser som används för att skapa dem. Bilderna visar filsökvägen i sidospåret [!UICONTROL Attributes] som återspeglar schemats struktur. Avsnittet [!UICONTROL Segment properties] till höger om skärmen innehåller en skriftlig beskrivning av målgruppens attribut.
...
![Gränssnittet visar exempel på 1 inställningar](../assets/segmentation/b2b/example-1.png)
...
![Gränssnitt som visar exempel på 2 inställningar](../assets/segmentation/b2b/example-2.png)
...
![Gränssnitt som visar exempel på 3 inställningar](../assets/segmentation/b2b/example-3.png)
...
Hitta alla personer som är en&quot;beslutsfattare&quot; för alla möjligheter där kontot finns i&quot;finansbranschen&quot; och som har besökt prissidan de senaste tre dagarna.

Om ni vill skapa den här målgruppen måste ni använda&quot;segment av segment&quot; genom att skapa en baspublik med alla de personer som besökt prissidan de senaste tre dagarna.

![Segment Builder som visar basmålgruppen.](../assets/segmentation/b2b/example-4-base.png)

När ni har skapat den första målgruppen kan ni kombinera det med en annan målgrupp som är en&quot;beslutsfattare&quot; för varje möjlighet där kontot finns i&quot;finanssektorn&quot;.

![Gränssnitt som visar exempel på 4 inställningar](../assets/segmentation/b2b/example-4.png)
...
![Gränssnitt som visar exempel på 5 inställningar](../assets/segmentation/b2b/example-5.png)
...
![Gränssnitt som visar exempel på 6 inställningar](../assets/segmentation/b2b/example-6.png)
...
Hitta alla personer som är en&quot;beslutsfattare&quot; för alla stängda möjligheter och som har besökt prissidan de senaste tre dagarna.

Om ni vill skapa den här målgruppen måste ni använda&quot;segment av segment&quot; genom att skapa en baspublik med alla de personer som besökt prissidan de senaste tre dagarna.

![Segment Builder som visar basmålgruppen.](../assets/segmentation/b2b/example-7-base.png)

När du har skapat den första målgruppen kan du kombinera det med en annan målgrupp som är en&quot;beslutsfattare&quot; för varje möjlighet där både den stängda flaggan är inställd på true och den förlorade flaggan är inställd på false.

![Gränssnittet visar exempel på 7 inställningar](../assets/segmentation/b2b/example-7.png)
...
![Gränssnitt som visar segmentering för relaterade konton](../assets/segmentation/b2b/example-8.png)
...
![Gränssnitt som visar segmentering för prediktiv lead- och kontopoäng](../assets/segmentation/b2b/example-9.png)
...
![Gränssnitt som visar den överordnade segmenteringsorganisationen](../assets/segmentation/b2b/example-10.png)
...
![Gränssnitt som visar den överordnade segmenteringsorganisationen](../assets/segmentation/b2b/example-11.png)
...
![Gränssnitt som visar den överordnade segmenteringsorganisationen](../assets/segmentation/b2b/example-12.png)
...
När du har läst den här översikten har du nu en förståelse för de segmenteringsmöjligheter som finns med Real-Time CDP, B2B edition. Mer information om segmenteringstjänsten finns i [Segmenteringsdokumentationen](../../segmentation/home.md).
