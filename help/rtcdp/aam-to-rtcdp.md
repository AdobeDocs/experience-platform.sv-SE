...
![Utvecklingsdiagram för Audience Manager till Real-Time CDP](/help/rtcdp/assets/aam-to-rtcdp-evolution.png)

## &#x200B;1. Överväg dataarkitekturen inom Audience Manager
...
Tänk dessutom på de datakällor du använder i Audience Manager.
...
Baserat på sina utvärderingskriterier bör segment som inte har några databeroenden, inga mål- eller aktiveringsproblem och deras segmenteringsregler skapas via Real-Time CDP datainsamling som [Adobe Experience Platform Web SDK](/help/collection/js/faq.md) vid ett senare datum skickas via Audience Manager Source Connector.

## &#x200B;3. Kommer du att använda målet [!UICONTROL Experience Cloud Audiences] för att hämta data till Audience Manager?

Segment som har regler som kan stödjas i Real-Time CDP men som har aktiveringsberoenden till Audience Manager kan skickas till Audience Manager via målkortet [Experience Cloud Audiences](/help/destinations/catalog/adobe/experience-cloud-audiences.md).

## &#x200B;4. Vilka destinationer har ni i Audience Manager idag och kan börja flytta till Real-Time CDP?
...
När du har läst den här sidan har du nu en första uppsättning överväganden att gå igenom när du börjar utveckla från Audience Manager till Real-Time CDP.
