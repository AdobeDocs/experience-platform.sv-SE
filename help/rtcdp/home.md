...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Kom igång</strong><br/>Få en översikt över Real-Time CDP och lär dig hur du importerar, hanterar och aktiverar data i stor skala med Real-Time CDP.</div>
    </td>
    <td>
    <a href="/help/rtcdp/overview.md#rtcdp-editions"><img src="assets/do-not-localize/start-campaign.jpeg"></a>
    <div><strong>Vilken utgåva av Real-Time CDP som passar mitt företag</strong><br/>Förstå skillnaderna mellan de olika utgåvorna av Real-Time CDP och bestäm vilken utgåva som passar ditt företag bäst.</div>
    </td>
    <td>
    <a href="/help/landing/ui-guide.md"><img src="assets/do-not-localize/start-interface.jpeg"></a>
    <div><strong>Användargränssnitt</strong><br/>Förstå elementen på Real-Time CDP användargränssnittets hemsida, navigera och optimera din produktupplevelse.</div>
    </td>
    <td>
    <a href="/help/landing/end-to-end-tutorial.md"><img src="assets/do-not-localize/start-journey.jpeg"></a>
    <div><strong>Utforska ett komplett arbetsflöde</strong><br/>Förstå dataflödet från konsumtion till aktivering genom att berika profiler och skapa målgrupper.
    </div>
    </td>
    <td>
    <a href="/help/rtcdp/use-case-guides/overview.md"><img src="assets/do-not-localize/start-use-cases.jpeg"></a>
    <div><strong>Exempel på Real-Time CDP-användningsfall</strong><br/>Upptäck hur Real-Time CDP kan hjälpa ditt företag att skaffa nya kunder, berika dina kända profiler och mycket annat.
    </div>
    </td>
  </tr>
  <tr style="border: 0;">
...
<table style="table-layout:auto">
  ...
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>Utvecklare</strong><br/>Använd de olika API:er och SDK:er som tillhandahålls av Real-Time CDP för att ställa in dataöverföring, hantera profiler, skapa målgrupper och mycket annat. <br/><a href="/help/landing/api-authentication.md">Autentisera och kom igång med API:er</a> - <a href="https://developer.adobe.com/experience-platform-apis/">Fullständig API-referens</a> - <a href="/help/destinations/destination-sdk/overview.md">Destination SDK</a> - <a href="/help/sources/sources-sdk/overview.md">Källor SDK</a> - <a href="https://developer.adobe.com/client-sdks/home/getting-started/get-the-sdk/">Mobile SDK</a>
    </td>
  </tr>
</table>
...
<tr>
  <td>
    ...
    <p>
    <em>Förstå var Real-Time CDP passar in i den större Adobe Experience Cloud</em>
    <p>
  </td>
  <td>
