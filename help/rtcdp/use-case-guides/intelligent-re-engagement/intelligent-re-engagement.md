...
Den här resan gäller produkter som har placerats i varukorgen men inte köpts på både webbplatsen och i appen. Används för att starta och stoppa betald media-kampanjer
...
Den här resan gäller produktköp både på webbplatsen och i appen.
...
### Konfigurera en schemadesign och fältgrupper

Det finns fyra schemadesigner som används för intelligenta återengagemangsresor. Varje schema kräver att specifika fält ställs in, samt vissa fält som är starkt rekommenderade.

>[!BEGINTABS]

>[!TAB Kundattribut (profilschema)]

Fältgrupperna som krävs för profilschemat är:
...
![En inspelning av kundattributschemat som visar en lista med fältgrupper.](../intelligent-re-engagement/images/customer-attributes.gif)

>[!TAB Digitala kundtransaktioner]

Fältgrupperna som krävs för Experience Event Schema för onlineaktivitet (inte Adobe Analytics Connector) är:
...
![En inspelning av kundens digitala transaktionsschema med en lista över fältgrupper.](../intelligent-re-engagement/images/customer-digital-transactions.gif)

>[!TAB Offlinetransaktioner för kund]

Fältgrupperna som krävs för Experience Event Schema för offlineaktivitet är:
...
![En inspelning av kundens offlinetransaktionsschema med en lista över fältgrupper.](../intelligent-re-engagement/images/customer-offline-transactions.gif)

>[!TAB Adobe webbanslutningsschema]
...
![En inspelning av Adobe Web Connector-schemat som visar en lista med fältgrupper.](../intelligent-re-engagement/images/adobe-web-connector.png)
...
Följande evenemang används för återengagemangsresan där profilerna visade produkter online och inte lade till i kundvagnen under de kommande 24 timmarna, följt av inget varumärkesengagemang under de kommande 3 dagarna.
