...
| [!DNL Experience Cloud Visitor ID] | Om något av detta upptäcks ger information om det [Experience Cloud ID (ECID)](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html) som tilldelats den aktuella besökaren. |
| [!DNL experienceCloud] | Innehåller Experience Cloud-ID:n för den här specifika användarsessionen: ett A4T [kompletterande data-ID](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/before-implement.html?#section_2C1F745A2B7D41FE9E30915539226E3A) och ett [besökar-ID (ECID)](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html). |
| [!DNL id] | [Mål-ID](https://developers.adobetarget.com/api/delivery-api/#section/Identifying-Visitors/Target-ID) för besökaren. |
| [!DNL Mbox Host] | Den [värd](https://experienceleague.adobe.com/docs/target/using/administer/hosts.html) som Target-begäran gjordes till. |
| [!DNL Mbox PC] | En sträng som kapslar in sessions-ID [`mbox`](https://developer.adobe.com/target/implement/client-side/atjs/global-mbox/global-mbox-overview/) och platstipset [Adobe Target Edge](https://experienceleague.adobe.com/docs/target/using/introduction/how-target-works.html#concept_0AE2ED8E9DE64288A8B30FCBF1040934). Det här värdet används av at.js för att säkerställa att sessionen och Edge-platsen förblir fästa. |
...
| [!DNL mbox3rdPartyId] | [`mbox3rdPartyId`](https://experienceleague.adobe.com/docs/target/using/audiences/visitor-profiles/3rd-party-id.html) som tilldelats den aktuella besökaren. |
