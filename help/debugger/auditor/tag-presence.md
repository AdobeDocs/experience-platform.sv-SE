...
| --- | --- | --- | --- |
| Adobe Advertising - kodnärvaro | 5 | Adobe Advertising-taggen är inte tillgänglig i DOM. | Implementera Adobe Advertising-taggen med [Adobe Advertising-taggtillägget](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
| Adobe Advertising - segmentpixel implementerad | 5 | Uppgradera dina Adobe Advertising-segmentpixlar till de nya Adobe Advertising-taggar som bara innehåller bilder. Om du använder de föråldrade AMO-segmenttaggarna kan data gå förlorade. | Implementera Adobe Advertising-segmentpixeln med [Adobe Advertising-taggtillägget](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
