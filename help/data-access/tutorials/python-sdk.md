...
>[!NOTE] De funktioner som används för filtrering är skiftlägeskänsliga.
...
>!![NOTE] Sökvägar till data lagras **inte** av SDK:n. Användarna måste lagra motsvarande sökväg till sina respektive data.
