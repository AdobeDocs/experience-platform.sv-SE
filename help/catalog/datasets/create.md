...
Alla begäranden som innehåller en nyttolast (POST, PUT, PATCH) kräver ytterligare ett `Content-Type: application/json`-huvud. För JSON+PATCH-begäranden ska `Content-Type` vara `application/json-patch+json`.
