...
PQL (Profile Query Language) har funktioner som underlättar interaktion med strängar. Mer information om andra PQL-funktioner finns i översikten [för](./overview.md)profilfrågespråk.
