...
Om din målgrupp är inom sju dagar efter utgångsdatum kan du välja **[!UICONTROL Refresh data expiration]** för att importera den senaste lyckade gruppen för målgruppen igen.
...
>[!NOTE]
>
>Förfallodatumet för anpassade data anger antalet dagar som profiler **kvarstår** i målgruppsmedlemskapet. När utgångsdatumet för data är över avslutas målgruppsmedlemskapet. Det här värdet kan anges mellan 1 och 90 dagar.
