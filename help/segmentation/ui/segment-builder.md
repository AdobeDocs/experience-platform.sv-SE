...
Du kan välja ![inställningsikonen](/help/images/icons/settings.png) om du vill justera inställningarna för de fält som visas.

För **[!UICONTROL Available fields]** kan du antingen bara visa fält som innehåller data eller det fullständiga XDM-schemat.

För **[!UICONTROL Data sources]** kan du filtrera för att visa attribut som kommer från de angivna matningstyperna. Värden som stöds är **[!UICONTROL Show batch data]**, **[!UICONTROL Show streaming/edge data]** och **[!UICONTROL Show fields with no ingested data]**.

För **[!UICONTROL Merge policy]** kan du välja vilken sammanfogningsprincip fälten tillhör.

![Inställningsområdet visas i Segment Builder.](../images/ui/segment-builder/settings.png)
...
När du väljer ett attribut kan du se sammanfattningsdata genom att välja [informationsikonen](../../images/icons/info.png). Sammanfattningsdata innehåller information om t.ex. en förklaring av vad fältet är, antalet poster för värdena samt procentandelen konton som innehåller värden för attributet.
...
![En pover som visar sammanfattningsdata för ett attribut](/help/segmentation/images/ui/segment-builder/summary-data.png)

Om ett attribut är fyllt av mindre än 25 % av profilerna visas i stället ![datavisningsikonen](../../images/icons/data-notice.png). Samma sammanfattningsdata kommer att visas för attributet, oavsett.

>[!NOTE]
>
>De översta värdena visas bara om fältet **inte** innehåller för många olika värden och om dessa fälts värden vanligtvis upprepas. Den här sammanfattningen uppdateras dessutom **dagligen**.
...
![Inmatningstypen för attributet visas.](/help/segmentation/images/ui/segment-builder/ingestion-type.png)
...
| ---------------- | ---- | --------- |
| Logisk komplexitet | Kritisk validering | Målgruppsdefinitionen är för komplicerad. |
