...
>[!NOTE] Dockerlösenordet ändras när du `{ACCESS_TOKEN}` uppdaterar.
...
## Skapa en motor med hjälp av Docker URL:er
...
## Skapa en motor med binära artefakter
...
## Skapa en funktionspipeline med binära artefakter

Du kan skapa en rörlig funktionsmotor med hjälp av lokala `.jar` eller `.egg` binära artefakter genom att utföra en POST-begäran och samtidigt tillhandahålla dess metadata och artefaktens sökvägar i multipart-formulär. En PySpark- eller Spark-motor kan ange beräkningsresurser, till exempel antalet kärnor eller mängden minne. Mer information finns i bilagan om [resurskonfigurationer](./appendix.md#resource-config) för PySpark och Spark.
