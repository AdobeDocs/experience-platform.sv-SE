...
Ett godkänt svar returnerar texten som upptäcktes i `feature_value`-arrayen. Texten läses och returneras uppifrån och ned från vänster till höger. Det innebär att om &quot;Jag älskar Adobe&quot; upptäcktes returnerar din nyttolast &quot;I&quot;, &quot;Love&quot; och &quot;Adobe&quot; i separata objekt. I objektet får du ett `feature_name` som innehåller ordet och ett `feature_value` som innehåller ett konfidensmått för texten.
