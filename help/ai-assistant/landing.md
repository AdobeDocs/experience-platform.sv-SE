---
title: AI Assistant (äldre) i Adobe Experience Platform produktdokumentation
description: Kom igång med AI Assistant (äldre) i Adobe Experience Platform.
...
# AI Assistant (äldre) i Adobe Experience Platform produktdokumentation

AI Assistant (äldre) i Adobe Experience Platform är ett konversationsverktyg som du kan använda för att snabba upp dina arbetsflöden med Experience Platform program och tjänster. Använd AI Assistant (äldre) för att öka den övergripande produktiviteten, få en bättre förståelse för produktkunskaper och operativa insikter samt samla in rekommendationer som är relevanta för era frågor och affärssituationer.

AI Assistant (äldre) stöder Experience Platform, Real-Time CDP, Adobe Journey Optimizer och Customer Journey Analytics.

## Kom igång

Kom igång genom att läsa materialet i länkarna nedan för att bekanta dig med koncepten och funktionerna i AI Assistant (äldre).
...
### Handledning som ökar produktiviteten med AI Assistant (äldre)
...
Nedan finns en praktisk guide om hur du kan höja din produktivitet med AI Assistant (äldre).
...
Få en glimt av de senaste förbättringarna i AI Assistant (äldre), inklusive funktioner som finns i Alpha- eller Beta-stadierna.
...
Du kan använda AI Assistants (äldre) naturliga språkuppskattningsfunktioner för att uppskatta målgruppsstorlekar och förutse målgruppernas egenskaper, vilket ger dig enklare tillgång till insikter om era målgrupper.
...
Du kan använda AI Assistant (äldre) för att hjälpa dig att identifiera XDM-fält (Experience Data Model) som du sedan kan använda för att skapa målgrupper inom Experience Platform.
...
Du kan använda Product Support Agent i AI Assistant (äldre) för att felsöka utan att behöva lämna dina arbetsflöden. Vid behov kan supportadministratörer nu använda Product Support Agent för att skapa kundsupportärenden, med kontext- och sessionsinformation från dina interaktioner med AI Assistant (äldre).
...
I följande videofilmer finns ytterligare exempel på hur du använder AI Assistant (äldre):
...
Klicka på länkarna nedan för att få en bättre förståelse för hur AI Assistant (äldre) används, har funktioner och mycket annat.
