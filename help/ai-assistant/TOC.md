...
* [AI Assistant (äldre) - produktdokumentation](landing.md)
* [AI Assistant (äldre) - översikt](home.md)
* [Funktionsåtkomst](access.md)
* [Frågeguide för AI Assistant (äldre)](questions.md)
...
* Nya funktioner {#new-features}
   * [AI Assistant-funktioner (äldre) i Alpha och Beta](./new-features/alpha-beta.md)
