...
* **Åtkomst till programmet:** Du kan komma åt AI Assistant (äldre) i Adobe Experience Platform, Adobe Real-Time CDP, Adobe Journey Optimizer och [Customer Journey Analytics](https://experienceleague.adobe.com/sv/docs/analytics-platform/using/ai-assistant).
...
När du har de behörigheter som krävs kan du komma åt AI Assistant (äldre) genom att välja ikonen ![AI Assistant (äldre)](/help/images/icons/ai-assistant.png) längst upp i det program du använder.
