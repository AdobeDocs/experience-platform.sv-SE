...
Om du vill installera tillägget väljer du **[!UICONTROL Extensions]** i den vänstra navigeringen. Markera **[!UICONTROL Catalog]** på fliken **[!UICONTROL TikTok Web Events API Extension]** och välj sedan **[!UICONTROL Install]**.
...
| Telefon | Telefonnumret måste vara i E164-format `[+][country code][area code][local phone number]` innan hashning utförs. |
