---
title: Meta Conversions API Extension - översikt
description: Läs mer om Meta Conversions API-tillägget för vidarebefordran av händelser i Adobe Experience Platform.
...
Om du vill installera tillägget [!DNL Meta Conversions API] går du till användargränssnittet för datainsamlingen eller användargränssnittet för Experience Platform och väljer **[!UICONTROL Event Forwarding]** i den vänstra navigeringen. Här väljer du en egenskap som tillägget ska läggas till i eller skapar en ny egenskap i stället.
...
Integreringen med Facebook- och Instagram-tilläggen gör att du snabbt kan autentisera dig i ditt Meta Business Account. Detta fyller sedan automatiskt i [!UICONTROL Pixel ID] och Meta Conversions API [!UICONTROL Access Token], vilket gör det enklare att installera och konfigurera Meta Conversions API.

En dialogruta för autentisering i Facebook och Instagram visas när tillägget [!UICONTROL Meta Conversions API] installeras.
...
![Framhävning av Meta-händelser [!UICONTROL Rule] på konfigurationssidan [!UICONTROL Partner Name (alpha)] och [!UICONTROL Partner ID (alpha)].](../../../images/extensions/server/meta/live-ramp.png)
...
Med den här installationen installeras både Meta Conversions API och Meta Pixel-tilläggen automatiskt. Den här hybridimplementeringen rekommenderas av Meta för att samla in och vidarebefordra händelsekonverteringar på serversidan.
...
I dialogrutan [!UICONTROL Validation Results] visas implementeringsresultaten för Meta-tillägget. Välj **[!UICONTROL Next]**.  Du kan även se ytterligare valideringsresultat genom att välja länken **[!UICONTROL Assurance]**.
