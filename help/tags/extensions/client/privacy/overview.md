---
title: Adobe Privacy Extension - översikt
description: Läs mer om tillägget Adobe Privacy tag i Adobe Experience Platform.
...
# Översikt över Adobe Sekretesstillägg
...
I den här guiden beskrivs hur du installerar och konfigurerar Adobe Sekretesstillägg i användargränssnittet för Experience Platform och datainsamling.
...
Välj **[!UICONTROL Extensions]** i den vänstra navigeringen, följt av fliken **[!UICONTROL Catalog]**. Använd sökfältet för att begränsa listan över tillgängliga tillägg tills du hittar Adobe sekretess. Välj **[!UICONTROL Install]** om du vill fortsätta.
...
Tillägget för Adobe sekretess innehåller tre åtgärdstyper som kan användas i en [regel](../../../ui/managing-resources/rules.md) när en viss händelse inträffar och villkoren uppfylls:
...
När du använder taggtillägget Adobe Privacy måste du tillhandahålla den återanropsfunktion som krävs i form av ett dataelement. Gå till nästa avsnitt för steg om hur du konfigurerar det här dataelementet.
...
När du har konfigurerat ett dataelement för återanrop för att hantera hämtade ID:n, kan du skapa en regel som anropar Adobe sekretesstillägg när en viss händelse inträffar på webbplatsen tillsammans med andra villkor som du behöver.
...
Härifrån kan du fortsätta att konfigurera regeln så att Adobe sekretessåtgärd utlöses under de händelser och villkor du behöver. Välj **[!UICONTROL Save]** när du är nöjd.
...
När du har installerat tillägget kan du inaktivera eller ta bort det. Välj **[!UICONTROL Configure]** på Adobe Sekretesskort i de installerade tilläggen och välj sedan **[!UICONTROL Disable]** eller **[!UICONTROL Uninstall]**.

## Nästa steg

I den här handboken beskrivs användningen av taggtillägget Adobe Privacy i användargränssnittet. Mer information om funktionerna som tillägget ger, inklusive exempel på hur du använder raw-kod, finns i [Översikt över JavaScript-bibliotek för sekretess](../../../../privacy-service/js-library.md) i Privacy Service-dokumentationen.
