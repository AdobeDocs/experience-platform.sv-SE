...
Den här sidan beskriver de händelsetyper för Adobe Experience Platform som finns i taggtillägget Adobe Experience Platform Web SDK. Dessa används för att [skapa regler](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-rules.html?lang=sv-SE) och ska inte blandas ihop med fältet `eventType` i [`xdm` object](/help/collection/js/commands/sendevent/xdm.md).
