...
Mer information om hur du kommer igång med mobila egenskaper finns i [Mobile](https://experienceleague.adobe.com/docs/platform-learn/data-collection/mobile-sdk/overview.html).
...
1. Rättigheterna i Admin Console har ändrats något.  Hantera egenskaper tillhör nu gruppen Företagsrättigheter.  Alla andra behörigheter (Hantera miljöer, Hantera tillägg, Utveckla, Godkänn och Publish) finns i gruppen Egenskapsrättigheter.
