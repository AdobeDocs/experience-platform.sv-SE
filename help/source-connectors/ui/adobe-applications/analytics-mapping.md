...
| m_browser_width | environment.browserDetails.viewWidth | heltal | Webbläsarens bredd i pixlar. |
...
| m_geo_zip | placeContext.geo.mailCode | string | Träffens postnummer. Detta baseras på träffens IP-adress. |
...
| mobileplaceentry | placeContext.POIinteraction.poiEnentries | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| mobileplaceexit | placeContext.POIinteraction.poiExits | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videotid | media.mediaTimed.timePlay | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videostart | media.mediaTimed.imponsions | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videoslutförd | media.mediaTimed.complete | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videosegmentvyer | media.mediaTimed.mediaSegmentViews | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videoadstart | advertising.imponations | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videoadcomplete | advertising.complete | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videoadtime | advertising.timePlayed | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videochapterstart | media.mediaTimed.mediaKapitel.imponsions | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videochaptercomplete | media.mediaTimed.mediaChapter.complete | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videochaptertime | media.mediaTimed.mediaChapter.timePlay | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
| videospela | media.mediaTimed.opens | Objekt | <!-- MISSING --> | {id (sträng), value (number)} |
...
| m_ref_type | web.webReference.type | string | Ett numeriskt ID som representerar typen av referens för träffen. 1 betyder inom er webbplats, 2 betyder andra webbplatser, 3 betyder sökmotorer, 4 betyder hårddisk, 5 betyder USENET, 6 betyder Typed/Bookmarked (ingen referent), 7 betyder e-post, 8 betyder Inget JavaScript och 9 betyder Sociala nätverk. |
...
| post_browser_width | environment.browserDetails.viewWidth | heltal | Webbläsarens bredd i pixlar. |
...
| geo_zip | placeContext.geo.mailCode | string | Träffens postnummer. Detta baseras på träffens IP-adress. |
...
| ref_type | web.webReference.type | string | Ett numeriskt ID som representerar typen av referens för träffen. |
