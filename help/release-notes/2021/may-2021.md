...
| --- | --- |
| Profilinsikter | Profilpanelen ger en daglig översikt över kundprofilsmått i realtid för varje organisationssammanslagningsprincip i Experience Platform. Dessa profilinsikter är tillgängliga för alla användare med möjlighet att komma åt och visa profildata inom plattformen. |
