...
| Stöd för Adobe Audience Manager-data | Uppdaterad funktionalitet som stöder Adobe Audience Manager datauppsättningar via Audience Manager källanslutning utan behov av att ETL era data för att följa CEE-schemat (Consumer Experience Event). |
...
Adobe Experience Platform segmenteringstjänst tillhandahåller ett användargränssnitt och RESTful API som gör att du kan skapa segment och generera målgrupper utifrån dina [!DNL Real-Time Customer Profile]-data. Dessa segment konfigureras och underhålls centralt på Experience Platform, vilket gör dem tillgängliga för alla Adobe-program.
...
| Funktion | Beskrivning |
| ------- | ----------- |
| [!DNL Marketo Engage] (Beta) | Du kan nu skapa en [!DNL Marketo Engage]-källanslutning med användargränssnittet för att hämta B2B-data till Experience Platform och hålla dessa data uppdaterade med Experience Platform-anslutna program. Mer information finns i [[!DNL Marketo Engage] källanslutningsdokumentationen](../../sources/connectors/adobe-applications/marketo/marketo.md). |
