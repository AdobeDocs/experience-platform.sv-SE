...
## Experience Platform Web SDK och Experience Platform Edge Network
...
| AEP Web SDK Mixin | En mixin som ska användas med AEP web SDK som omfattar alla fält som stöds. |
| Kontroll av kursens samtycke | Ger företag kontroll över deltagande och avanmälan av AEP Web SDK |
| Stöd för felsökning på klientsidan i nya Experience Cloud Debugger Extension | Se förfrågningar från AEP web SDK och kantspårningar för att se hur data flödar genom systemet. |
