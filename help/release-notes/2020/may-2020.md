...
| Recept | New PySpark and [!DNL Spark] recensionerna följer nu [!DNL Docker] arbetsflöde som liknar [!DNL Python] och R-recept. |
...
CDP har nu stöd för dataaktivering i realtid till [!DNL Facebook]så att du kan aktivera profiler för [!DNL Facebook] kampanjer för målgruppsanpassning, personalisering och undertryckande baserat på hashad-e-post.

Mer information om de nya funktionerna finns i [Facebook](../../destinations/catalog/social/facebook.md) sida.
...
>[!NOTE]
>
>The [!DNL Amazon Kinesis] och [!DNL Azure Event Hubs] mål i CDP i realtid är för närvarande i betaversion. Dokumentationen och funktionaliteten kan komma att ändras.

| Dokumentation | Beskrivning |
|--- | ---|
| [(Beta) Amazon Kinesis](../../destinations/catalog/cloud-storage/amazon-kinesis.md) | I den här artikeln beskrivs hur du skapar en utgående anslutning i realtid till din [!DNL Amazon Kinesis] lagring för att strömma data från Adobe Experience Platform. |
| [(Beta) Azure Event Hubs-mål](../../destinations/catalog/cloud-storage/azure-event-hubs.md) | I den här artikeln beskrivs hur du skapar en utgående anslutning i realtid till din [!DNL Azure Event Hubs] lagring för att strömma data från Adobe Experience Platform. |
...
Mer information om [!DNL Platform Web SDK] och [!DNL Edge Network], se [dokumentation](../../edge/home.md).
