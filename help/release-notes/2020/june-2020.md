...
| Funktion | Beskrivning |
| ------- | ----------- |
| Ytterligare API- och gränssnittsstöd för molnlagringssystem | Nya källanslutningar för Apache HDFS |
| Ytterligare API- och gränssnittsstöd för databaser | Nya källkopplingar för Couchbase. |
