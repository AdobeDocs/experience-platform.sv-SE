...
| --- | --- | --- |
| Web SDK | Spåra automatiskt interaktion med förslag | Du kan nu använda egenskapen `autoTrackPropositionInteractionsEnabled` i Web SDK för att avgöra om Web SDK ska samla in offertinteraktioner automatiskt. Se [`autoTrackPropositionInteractionsEnabled`](../../web-sdk/commands/configure/autotrackpropositioninteractionsenabled.md)-dokumentationen för detaljerad information. |
...
Med Unified Tags kan du kategorisera och hantera dina affärsobjekt i Adobe Experience Platform. Med Unified Tags API:et kan du skapa både mappar och taggar för att bättre organisera Platform-objekt, t.ex. målgrupper och datauppsättningar.
