...
| Funktion | Beskrivning |
| --- | --- |
| [Google Kundmatchning + DV360](../../destinations/catalog/advertising/google-customer-match-dv360.md) allmän tillgänglighet | Google Kundmatchning + DV360-destination erbjuds nu till alla Experience Platform-användare. Nu innehåller dokumentationen en detaljerad vägledning för [kontolänkning](../../destinations/catalog/advertising/google-customer-match-dv360.md#linking) mellan [!DNL Adobe]- och [!DNL Google]-annonskonton. |
