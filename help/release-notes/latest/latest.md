...
Real-time Customer Data Platform Connections innehåller en serie tekniker som gör att du kan samla in kundupplevelsedata på klientsidan och skicka dem till Adobe Experience Platform Edge Network där de kan berikas, omformas och distribueras till Adobe eller andra platser än Adobe.
...
Mer information finns i [Real-Time CDP Connections overview](../../rtcdp-connections/home.md).
