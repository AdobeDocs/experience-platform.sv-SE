...
| Funktion | Beskrivning |
| --- | --- |
| [Google kundmatchning + DV360](../../destinations/catalog/advertising/google-customer-match-dv360.md) allmän tillgänglighet | Google kundmatchning + DV360-destinationen är nu tillgänglig för alla Experience Platform-användare. Dokumentationen innehåller nu detaljerad vägledning för [kontolänkning](../../destinations/catalog/advertising/google-customer-match-dv360.md#linking) mellan [!DNL Adobe]- och [!DNL Google]-annonskonton. |
