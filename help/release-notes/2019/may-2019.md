...
Direktinmatning skickar data till [!DNL Experience Platform] i realtid från klient- och serverenheter. Du kan uppdatera till [!DNL Real-Time Customer Profiles] med mindre fördröjning med stöd för autentiserad datainsamling och nyttolaster med flera poster.
