...
Adobe Experience Platform har en mängd funktioner för inhämtning av alla typer och all fördröjning av data. Du kan importera med hjälp av API:er för batch- eller direktuppspelning med hjälp av Adobe-byggda anslutningar, dataintegrationspartners eller Adobe Experience Platform-gränssnittet.
...
Övervaka strömmande data i Adobe Experience Platform från klient- och serverenheter i realtid.
