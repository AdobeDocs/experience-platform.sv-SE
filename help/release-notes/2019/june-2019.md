...
| Egen `$id` | Nu kan du ange en egen `$id` när du skapar resurser i POSTER. |
...
* Korrigerat fel där [!DNL Schema Registry] har gett slumpmässiga svar för anrop till profilunion.
