...
Adobe Experience Platform [!DNL Decisioning Service] kan programmatiskt och intelligent välja&quot;Nästa bästa upplevelse&quot; bland en uppsättning tillgängliga alternativ för en viss individ, leverera dem till valfri kanal eller tillämpning samt utföra rapportering och analys.
...
Mer information finns i översikten över [beslutstjänsten](../../decisioning-service/home.md).

## [!DNL Query Service] {#query}

[!DNL Query Service] ger möjlighet att använda standard-SQL för att fråga data i Adobe Experience Platform som stöd för många olika analyser och datahanteringssituationer. Det är ett serverlöst verktyg som gör att du kan koppla till alla datauppsättningar i [!DNL Data Lake] och samla in frågeresultaten som en ny datauppsättning för användning vid rapportering [!DNL Data Science Workspace]eller för förtäring i [!DNL Profile Service].
