...
| [Adobe Advertising DSP](../../destinations/catalog/advertising/adobe-advertising-dsp-connection.md) | Med Adobe Advertising Cloud-målet [!DNL Demand-Side Platform] (DSP) kan du dela autentiserade förstapartssegment med godkända annonsörer och användare för kampanjaktivering med DSP. |
...
| [Återge förslag](/help/collection/js/commands/applypropositions.md) i enkelsidiga program utan att öka måtten. | Med det nya `applyPropositions`-kommandot kan du återge eller köra en array med förslag från [!DNL Target] till ensidiga program, utan att öka värdena för [!DNL Analytics] och [!DNL Target]. Denna förbättring ökar rapporteringsnoggrannheten. |
| [Delning av mobil-till-webb- och korsdomän-ID](/help/collection/use-cases/identity/id-sharing.md) | Adobe Experience Platform Web SDK har nu stöd för delning av besökar-ID som gör att ni kan leverera personaliserade upplevelser på ett mer korrekt sätt, mellan mobilappar och mobilwebbinnehåll, och över olika domäner. |
...
| Fältgrupper | [[!UICONTROL Lodging Reservation]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/industry-verticals/experienceevent-lodging-reservation.schema.json) | En incheckningsegenskap har lagts till. |
