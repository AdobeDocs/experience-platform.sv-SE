...
| [Adobe Advertising DSP](../../destinations/catalog/advertising/adobe-advertising-dsp-connection.md) | Med Adobe Advertising [!DNL Demand-Side Platform]-målet (DSP) kan du dela autentiserade förstapartssegment med godkända annonsörer och användare för kampanjaktivering med DSP. |
