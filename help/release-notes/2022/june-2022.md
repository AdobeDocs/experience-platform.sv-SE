...
| [Återge förslag](/help/collection/use-cases/personalization/rendering-personalization-content.md) i enkelsidiga program utan att öka måtten. | Med det nya `applyPropositions`-kommandot kan du återge eller köra en array med förslag från [!DNL Target] till ensidiga program, utan att öka värdena för [!DNL Analytics] och [!DNL Target]. Detta ökar rapporteringsnoggrannheten. |
