...
| Datatyp | [[!UICONTROL Media information]](https://github.com/lidiaist/xdm/blob/master/components/datatypes/media.schema.json) | Tillagda `xdm:playhead` för att spela in spelhuvudstiden för ett visst medieinnehåll. Fast mönstervalidering för `xdm:videoSegment`. |
