...
| --- | --- | --- |
| Fältgrupper | [[!UICONTROL Change set]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/changeset.schema.json) | Hämtar ändringar på radnivå till och från datauppsättningar. Den här fältgruppen kan användas av alla klasser. |
| Fältgrupper | [[!UICONTROL Reference keys]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-reference-keys.schema.json) | Hämtar referensnycklar för ExperienceEvent-scheman, vilket gör att du kan skapa relationer med scheman som baseras på andra klasser. |
...
| Fältgrupper | [[!UICONTROL Record Status]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/record-status.schema.json) | Fältgruppsstatusen har uppdaterats från `experimental` till `stable`. |
| Fältgrupper | (Flera) | Flera B2B-fältgrupper har uppdaterats så att vissa ID-fält har ersatts med nyckeltypsfält som använder datatypen [[!UICONTROL B2B Source]](../../xdm/data-types/b2b-source.md). Föregående ID-fält kommer att bli inaktuella i en framtida uppdatering. Se följande [pull-begäran](https://github.com/adobe/xdm/pull/1533/files#diff-720c0bb1d1cbaf622f5656c2a4b62d35830c75f6563794da72a280a6a520fbc1) för en fullständig lista över ändringar i de berörda fältgrupperna. |
