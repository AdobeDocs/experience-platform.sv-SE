...
**Stöd för taggar i Internet Explorer 10 och 11 upphör**

Adobe investerar inte längre i stöd för [Internet Explorer 10 (IE10)](https://docs.microsoft.com/en-us/lifecycle/announcements/internet-explorer-10-end-of-support) och [Internet Explorer 11 (IE11)](https://docs.microsoft.com/en-us/lifecycle/announcements/internet-explorer-11-end-of-support) för taggar i Adobe Experience Platform. Microsoft har upphört med stödet för dessa webbläsare, moderna webbtekniker är allt mer inkompatibla med dem och den bredare branschen har flyttats bort från dem. Dessa faktorer gör det svårt och kostsamt att bibehålla bakåtkompatibiliteten. Även om Adobe inte aktivt tar bort stödet för IE10 och IE11 testas eller optimeras inte längre nya taggfunktioner för dessa webbläsare. Tack vare den här förändringen kan Adobe leverera moderna funktioner snabbare.
...
| Fältgrupper | [[!UICONTROL Current Weather]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | En fältgrupp för klasserna [!UICONTROL XDM ExperienceEvent] och [!UICONTROL Weather] som används för att hämta aktuella väderförhållanden för ett postnummer. |
| Fältgrupper | [[!UICONTROL Forecasted Weather]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/forecasted-weather.schema.json) | En fältgrupp för klasserna [!UICONTROL XDM ExperienceEvent] och [!UICONTROL Weather], som används för att hämta de prognostiserade väderförhållandena för ett postnummer. |
| Fältgrupper | [[!UICONTROL Product Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/product-triggers.schema.json) | En fältgrupp för klasserna [!UICONTROL XDM ExperienceEvent] och [!UICONTROL Weather] som används för att hämta produktspecifika utlösare som utnyttjar väderförhållanden som är kända för att driva konsumentbeteenden. |
| Fältgrupper | [[!UICONTROL Relative Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/relative-triggers.schema.json) | En fältgrupp för klasserna [!UICONTROL XDM ExperienceEvent] och [!UICONTROL Weather] som används för att hämta relativa utlösare som utnyttjar väderförhållanden som är kända för att driva konsumentbeteenden. |
| Fältgrupper | [[!UICONTROL Severe Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/severe-triggers.schema.json) | En fältgrupp för klasserna [!UICONTROL XDM ExperienceEvent] och [!UICONTROL Weather] som används för att hämta utlösare som utnyttjar svåra väderförhållanden som är kända för att driva konsumentbeteenden. |
| Fältgrupper | [[!UICONTROL Weather Triggers]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/weather-triggers.schema.json) | En fältgrupp för klasserna [!UICONTROL XDM ExperienceEvent] och [!UICONTROL Weather] som används för att hämta allmänna utlösare som utnyttjar väderförhållanden som är kända för att driva konsumentbeteenden. |
| Fältgrupper | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/blob/master/docs/reference/fieldgroups/experience-event/experienceevent-media.schema.json) | En fältgrupp för klassen [!UICONTROL XDM ExperienceEvent] som samlar in information om en medieinteraktion. |
| Fältgrupper | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media-analytics.schema.json) | En fältgrupp för klassen [!UICONTROL XDM ExperienceEvent] som samlar in information om en interaktion med medierapportering. |
