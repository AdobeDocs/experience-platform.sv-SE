...
- [Lead till kontomatchning inom CDP B2B](#B2B)
...
## Lead till kontomatchning i CDP B2B (#lead-to-account-matching)

B2B-företag har ofta sin kundinformation lagrad i flera system, där alla bara innehåller partiella eller till och med motstridiga data för samma verkliga affärsenhet. Detta skapar en stor utmaning i att få en korrekt bild av kunderna och minskar därmed effektiviteten och effektiviteten i B2B-marknadsförings- och säljsatsningarna. I och med lanseringen av lead-to-account matching matchar CDP B2B kända personprofiler med kontoprofiler så att de kan segmenteras och riktas mot B2B-kontextdata som konto, affärsmöjlighet osv.

Läs mer om funktionen på följande dokumentationssidor:

- [Lead till kontomatchning i CDP B2B](../../rtcdp/b2b-ai-ml-services/lead-to-account-matching.md)
- [Lead till kontomatchningsprofilens berikning i guiden för profilberikning för bildskärm](../../dataflows/ui/b2b/monitor-profile-enrichment.md)
