...
| [[!DNL Data Landing Zone]](../../destinations/catalog/cloud-storage/data-landing-zone.md) | Nyhet | [!DNL Data Landing Zone] är ett [!DNL Azure Blob] lagringsgränssnitt som tillhandahålls av Adobe Experience Platform, vilket ger dig tillgång till en säker, molnbaserad fillagringsfunktion för att exportera filer från Experience Platform. Det nya målet har förbättrad filexportfunktion och stöder export av datauppsättningen [!BADGE Beta]{type=Informative}. |
