...
| Funktion | Beskrivning |
| ------- | ----------- |
| Förfallodatum för pseudonyma profiler | Nu kan pseudonyma profildata förfalla. Den här versionen tar kontinuerligt bort inaktuella pseudonyma profiler från din Experience Platform-instans när den har aktiverats. Om du vill veta mer om den här funktionen och pseudonyma profiler läser du [utgångsguiden för pseudonyma profildata](../../profile/pseudonymous-profiles.md). |
