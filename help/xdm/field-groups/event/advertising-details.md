...
# Schemafältgruppen [!UICONTROL Advertising Details]

[!UICONTROL Advertising Details] är en standardschemafältgrupp för [[!DNL XDM ExperienceEvent] klassen](../../classes/experienceevent.md). Fältgruppen tillhandahåller ett enskilt `advertising`-objekt till ett schema, som samlar in information om annonsvisningar, klickningar och attribuering.

![Fältgruppsstruktur](../../images/field-groups/advertising-details/structure.png)

| Egenskap | Datatyp | Beskrivning |
| --- | --- | --- |
| `adAssetReference` | Objekt | Hämtar resursinformation om annonsen. Mer information om objektets struktur finns i [underavsnittet nedan](#adAssetReference). |
| `adAssetViewDetails` | Objekt | Hämtar visningsinformation för annonsuppspelningen. Mer information om objektets struktur finns i [underavsnittet nedan](#adAssetViewDetails). |
| `adViewability` | Objekt | Hämtar det antal visningar som slutanvändarna ser, till exempel spelarvolym, biblioteksversion, fönsterstatus och visningsrutans dimensioner. Mer information om objektets struktur finns i [underavsnittet nedan](#adViewability). |
...
| `downloadedPlayback` | Boolean | När värdet är `true`, visar att träffen genereras på grund av att en hämtad annonssession spelas upp. |

{style="table-layout:auto"}

## `adAssetReference` {#adAssetReference}

Objektet `adAssetReference` hämtar resursinformation om annonsen.
...
| `_id` | Sträng | En unik identifierare för annonsresursen som följer [annons-ID-standarden](https://datatracker.ietf.org/doc/html/rfc8107). |
...
Objektet `adAssetViewDetails` hämtar visningsinformation för annonsuppspelningen.
...
| `index` | Heltal | Indexvärdet för annonsen inuti den överordnade annonsbrytningen. Den första annonsen har indexvärdet `0` och den andra annonsen har indexvärdet `1`. |
...
Objektet `adViewability` hämtar det antal visningar som slutanvändare kan se, till exempel spelarvolym, biblioteksversion, fönsterstatus och visningsrutans dimensioner.
...
| `playerVolume` | Heltal | Spelarvolymen i procent mätt vid körning, där `0` är avstängd och `100` är högsta volym. |
...
Mer information om fältgruppen finns i [den offentliga XDM-databasen](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-advertising.schema.json).
