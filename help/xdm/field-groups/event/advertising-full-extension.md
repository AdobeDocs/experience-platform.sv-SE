---
title: Fältgruppen Adobe Advertising ExperienceEvent Full Extension Schema
description: Läs mer om schemafältgruppen Adobe Advertising ExperienceEvent Full Extension.
...
# Schemafältgruppen [!UICONTROL Adobe Advertising ExperienceEvent Full Extension]

>[!AVAILABILITY]
>
>Fältgruppen [!UICONTROL Adobe Advertising ExperienceEvent Full Extension] är för närvarande i betaversion. Dokumentationen och funktionaliteten kan komma att ändras.

[!UICONTROL Adobe Advertising ExperienceEvent Full Extension] är en standardschemafältgrupp för [[!DNL XDM ExperienceEvent] klassen](../../classes/experienceevent.md), som samlar in vanliga mått som samlas in av Adobe Advertising (kallades tidigare [!DNL Advertising Cloud]).

Det här dokumentet beskriver strukturen och användningsfallet för tilläggsfältgruppen [!DNL Advertising].
...
![Fält på översta nivån för [!DNL Advertising]-fältgruppen](../../images/field-groups/advertising-full-extension/full-schema.png "Fält på översta nivån för  [!DNL Advertising] fältgruppen")
...
| `dspId` | Sträng | Identifieraren för den Demand Side Platform (DSP) som kampanjen är definierad i. Vanligtvis är den här identifieraren Adobe Advertising DSP-ID:t. |
...
| `sspPartnerCode` | Sträng | Den partner (den börs) genom vilken Adobe Advertising tar emot lagermöjligheten. |
...
| `inventorySourceId` | Sträng | ID för den Adobe Advertising-lagerkälla som affärsmöjligheten levererades på. |
...
Det här dokumentet innehöll struktur och användningsfall för fältgruppen [!DNL Adobe Advertising]. Mer information om själva fältgruppen finns i [den offentliga XDM-databasen](https://github.com/adobe/xdm/blob/master/extensions/adobe/experience/adcloud/experienceevent-all.schema.json).
