...
| `decisioning.propositionTrigger` | Händelser av den här typen lagras lokalt av Web SDK, men skickas inte till Edge Network. Varje gång en regeluppsättning är uppfylld genereras en händelse som lagras i ett lokalt lager (om den inställningen är aktiverad). |
