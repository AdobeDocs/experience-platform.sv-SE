...
# klassen [!UICONTROL XDM Business Account]
...
[!UICONTROL XDM Business Account] är en XDM-standardklass (Experience Data Model) som hämtar de minsta nödvändiga egenskaperna för ett företagskonto.

![Strukturen för XDM-företagskontoklassen så som den visas i användargränssnittet](../../images/classes/b2b/business-account.png)
