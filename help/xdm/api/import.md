---
title: Importera API-slutpunkt
description: Med slutpunkten /import i API:t för schemaregister kan du dela XDM-resurser mellan IMS-organisationer och sandlådor.
