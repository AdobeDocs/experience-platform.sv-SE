...
description: 'Ett schema kan ses som en plan för de data du vill importera till Experience Platform. Varje schema består av en klass och noll eller flera mixiner. Du behöver alltså inte lägga till en blandning för att definiera ett schema, men i de flesta fall används minst en blandning. '
