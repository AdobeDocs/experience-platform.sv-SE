...
description: Med schemaregistret kan du ersätta en hel resurs genom en PUT-åtgärd. Den här åtgärden skriver i princip om resursen, och därför måste begärandetexten innehålla alla fält som krävs när en ny resurs skapas med en begäran om POST.
