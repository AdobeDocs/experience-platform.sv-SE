...
title: ExperienceEvent EndUserID:n mixin
topic: overview
description: Det här dokumentet innehåller en översikt över ExperienceEvent EndUserID:n som mixin.
...
# [!UICONTROL ExperienceEvent EndUserIDs] blanda

[!UICONTROL ExperienceEvent EndUserIDs] är en standardblandning för [[!DNL XDM ExperienceEvent] klassen](../../classes/individual-profile.md)som används för att beskriva en individs identitetsinformation i flera Adobe-program. Mixin tillhandahåller ett `endUserIDs` objekt på rotnivå, som i sin tur innehåller ett skrivskyddat `_experience` fält vars värden uppdateras automatiskt när data importeras.
