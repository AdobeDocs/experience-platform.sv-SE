...
* **[!DNL Query Service]:**Använd SQL-frågor för att hämta data från Adobe Experience Platform, till exempel data från Adobe, kunddata från första part eller andra Platform-data.
...
* **[!DNL Sources](Anslutningar):**{#sources}Hämta in data i Adobe Experience Platform från en mängd olika källor som Adobe-program, molnbaserad lagring, databaser med mera.
