...
När du har skapat ett nytt datastam eller valt ett befintligt som du vill redigera, väljer du växlingsknappen bredvid **[!UICONTROL Adobe Experience Platform]**. Använd sedan värdena nedan för att fylla i formuläret.
...
| [!UICONTROL Profile Dataset] | Den [!DNL Profile]-aktiverade datauppsättningen med tillståndsfält som du skapade [tidigare](#prerequisites). |
