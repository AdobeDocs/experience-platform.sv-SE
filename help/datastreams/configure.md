...
Om du konfigurerar en datastream för användning i Experience Platform och även använder Web SDK, måste du även välja ett [händelsebaserat XDM-schema ](../xdm/classes/experienceevent.md) som representerar de data du planerar att använda vid inhämtning.
...
![Adobe-målgruppshantering för dataströmsinställningar.](assets/configure/audience-manager-config.png)
