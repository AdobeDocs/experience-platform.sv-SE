...
| [!UICONTROL First Party ID Cookie] | När den här inställningen är aktiverad anger den att Edge Network ska referera till en angiven cookie när ett [förstahandsenhets-ID](/help/collection/identity/fpid.md) identifieras, i stället för att leta upp det här värdet i identitetskartan.<br><br>När du aktiverar den här inställningen måste du ange namnet på den cookie som ska lagra ID:t. |
