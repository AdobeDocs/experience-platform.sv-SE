...
| [!UICONTROL Media Analytics] | Möjliggör bearbetning av spårningsdata för direktuppspelning för integrering av Edge Network via Experience Platform SDK eller Media Edge API. Läs om Media Analytics på [dokumentation](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html). |
